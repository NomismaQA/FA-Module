...
//	SeleniumLib sl;
	...
	private By ClickaccountboxElem = By.xpath("//span[@id='select2-ctl00_cPH_rptRecord_ctl00_ltAccount-container']");
...
//         }
// 		
 		BK_Settings dateob=new BK_Settings(m_Driver);
 		Enter_tDate=dateob.getDateforJournalEntry();
...
//Thread.sleep(1000);
 //elem.click();
     ...
     * @name Enter Clickaccountbox
     */
 	public void Enter_Clickaccountbox1(String Clickaccountbox) throws InterruptedException
 	{
 		m_Driver.switchTo().frame(getWebElement(By.xpath("//*[@id='ctl00_cPH_journalmodal1Iframe1']")));
 		WebElement elem = getWebElement(ClickaccountboxElem);
 		...
 		elem=m_Driver.findElement(By.xpath("//span[@id='select2-ctl00_cPH_rptRecord_ctl00_ltAccount-container']"));
 		
 		elem.click();
 		
 		WebElement Textareaelem=m_Driver.findElement(By.xpath("//INPUT[@class='select2-search__field']"));
 		
 		Textareaelem.sendKeys(Clickaccountbox);
...
//Thread.sleep(1000);
 //elem.click();
	...
	/**
 	 * Enter Enter_Debit	//*[@id='select2-ctl00_cPH_rptRecord_ctl00_ltAccount-results']/li/ul/li
...
//elem.click();
 		...
 		//jsExec.executeScript("arguments[0].click();", elem);
 	elem=	m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptRecord_ctl00_txtDebit']"));
...
//	}
     ...
     */
	public void Click_Click_Save_btn(String testtype) throws Exception
	{
	...
	//	System.out.println("return"+ret);
		...
		m_Driver.switchTo().defaultContent();
		TakeScreenshot.takeScreenshot(m_Driver, testtype+"Entry");
...
public void SelectFinancialYear(String yrDate) 
{
