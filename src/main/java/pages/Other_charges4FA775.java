...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/988cfeba-d1dd-4323-9def-50774149666c
@TestModellerModule(guid = "988cfeba-d1dd-4323-9def-50774149666c")
public class Other_charges4FA775 extends BasePage
{
	public Other_charges4FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[42]/td[2]")).getText();
						Assert.assertEquals(expected, "7030");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
