...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/1fce1ea8-d8ec-4073-94d9-e8fbbbaddf89
@TestModellerModule(guid = "1fce1ea8-d8ec-4073-94d9-e8fbbbaddf89")
public class Tax14FA775 extends BasePage
{
	public Tax14FA775 (WebDriver driver)
	{
		super(driver);
	}
