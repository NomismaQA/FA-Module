...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/82df650f-26e7-4d0a-a5c6-498be3e94f3a
@TestModellerModule(guid = "82df650f-26e7-4d0a-a5c6-498be3e94f3a")
public class Verify_default_status_of_Average_number_of_employees62 extends BasePage
{
	public Verify_default_status_of_Average_number_of_employees62 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By Edit1Elem = By.xpath("//*[@id=\"ctl00_cPH_rptrDisplayRecords_ctl02_lnkAdd\"]");
...
Thread.sleep(1000);
	...
	public void Click_Statement_of_Financial_Position()
	{
		...
		String expected = m_Driver.findElement(By.xpath("//*[@id=\"note_3\"]")).getText();
		Assert.assertEquals(expected, "(3) Average number of employees");
		elem.click();
