...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/f395de78-db20-40f8-b42b-ffa93062d0c2
@TestModellerModule(guid = "f395de78-db20-40f8-b42b-ffa93062d0c2")
public class DetailedIncomeStatementCostofrawmaterials7 extends BasePage
{
	public DetailedIncomeStatementCostofrawmaterials7 (WebDriver driver)
	{
		super(driver);
	}
