...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/4957bb3d-c1c2-4465-9bd5-b0d2dfa90d84
@TestModellerModule(guid = "4957bb3d-c1c2-4465-9bd5-b0d2dfa90d84")
public class Other_charges40FA775 extends BasePage {
	public Other_charges40FA775(WebDriver driver) {
		super(driver);
	}
...
//*/
	public void Click_Other_charges() {
		...
		try {
			...
			elem.click();
			Thread.sleep(5000);
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[68]/td[2]")).getText();
			Assert.assertEquals(expected, "7268");
