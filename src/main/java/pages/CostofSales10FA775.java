...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/0acea422-0545-4dd1-b4a2-63b5a2682e38
@TestModellerModule(guid = "0acea422-0545-4dd1-b4a2-63b5a2682e38")
public class CostofSales10FA775 extends BasePage
{
	public CostofSales10FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(7000);
			elem.click();
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_divScroll\"]/div/table/tbody[2]/tr[9]")).getText();
			Assert.assertEquals(expected, "5100	Purchases	3,543.00");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
