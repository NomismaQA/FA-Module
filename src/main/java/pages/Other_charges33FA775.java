...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/76864d7e-0acd-42ad-93ed-1082622dd2dc
@TestModellerModule(guid = "76864d7e-0acd-42ad-93ed-1082622dd2dc")
public class Other_charges33FA775 extends BasePage
{
	public Other_charges33FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[52]/td[2]")).getText();
						Assert.assertEquals(expected, "7208");
						...
						if(data.contains("7208"))
						{
							String[] dd = data.split("0");
							System.out.println(dd[0]);
							Assert.assertEquals(dd[0], "7208");
						}
						}
		} catch (Exception e) {
			// TODO Auto-generated catch block
