...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/c0051d7a-28c1-4541-a79f-13d6d7cbfc28
@TestModellerModule(guid = "c0051d7a-28c1-4541-a79f-13d6d7cbfc28")
public class Staff_costs10FA775 extends BasePage
{
	public Staff_costs10FA775 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By Staff_CostsElem = By.xpath("//A[@href='Popup/FAViewTrialBalance.aspx?StandardCode=2&MainSection=PL&Year=P&Section=STAFFCOST&FYCode=53174&CompanyCode=13249']");
  	...
  	public void Click_Staff_Costs()
  	{
  		...
  		try {
  			...
  			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
  						elem.click();
  						Thread.sleep(5000);
  						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[60]/td[2]")).getText();
  						Assert.assertEquals(expected, "7257");
  		} catch (Exception e) {
  			// TODO Auto-generated catch block
  			e.printStackTrace();
  		}
