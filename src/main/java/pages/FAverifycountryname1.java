...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/cc28584c-ea07-40d8-b1dd-9b78cfc965fe
@TestModellerModule(guid = "cc28584c-ea07-40d8-b1dd-9b78cfc965fe")
public class FAverifycountryname1 extends BasePage
{
	public FAverifycountryname1 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By CompanynameElem = By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_cPH_rptrDisplayRecords_ctl00_rowCompany\"]/td[1]/span");
	...
	private By Edit2Elem = By.xpath("//*[@id=\"ctl00_cPH_linkFinalAccount\"]/img");
...
Thread.sleep(1000);
	...
	public void Click__Clients_()
	{
		...
		if (elem == null) {
    		ExtentReportManager.failStepWithScreenshot(m_Driver, "Click__Clients_", "Click__Clients_ failed. Unable to locate object: ");

    		TestModellerLogger.FailStepWithScreenshot(m_Driver, "Click__Clients_", "Click__Clients_ failed. Unable to locate object: ");
...
//		String expected = jsExec.executeScript("return document.getElementById(//*[@id='ctl00_cPH_oldltCTPreview']/div/div/div[1]/table[1]/tbody/tr[1]/td).value");
//		System.out.println(expected);
//		Assert.assertEquals(expected, "Registered No. NI121212 (Northern Ireland)");
//		WebElement elem1 = getWebElement(Report);
//		if(elem1==null)
//		{
//			WebElement unable = getWebElement(unablereport);
...
//				String[] dd = data.split(":");
//			System.out.println(dd[0]);
//			 Assert.assertEquals("Partnership Registration Number : NI121212 (Northern Ireland)", dd[0]);
//			 }
//		
//        String dd = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[2]/div/table/tbody/tr[1]/td")).getText();
//		String[] data = dd.split(":");
//		m_Driver.switchTo().defaultContent();
