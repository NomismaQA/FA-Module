...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/3143af07-e618-42af-8ff5-a8e52b223963
@TestModellerModule(guid = "3143af07-e618-42af-8ff5-a8e52b223963")
public class Other_charges43FA775 extends BasePage
{
	public Other_charges43FA775 (WebDriver driver)
	{
		super(driver);
	}
...
//*/
	public void Click_Other_charges() {
		...
		try {
			...
			elem.click();
			Thread.sleep(5000);
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_rptrExpenseByDateRange_ctl51_lnkView\"]/span[1]")).getText();
			Assert.assertEquals(expected, "7507");
