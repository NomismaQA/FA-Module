...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/af522353-a097-4cb7-8bd4-cff7ad16049c
@TestModellerModule(guid = "af522353-a097-4cb7-8bd4-cff7ad16049c")
public class Cost_of_raw_materials_and_consumables7FA775 extends BasePage
{
	public Cost_of_raw_materials_and_consumables7FA775 (WebDriver driver)
	{
		super(driver);
	}
	...
	//added by ankit
//	private By Final_Accounts3Elem = By.xpath("//LI[@id='ctl00_SideMenu1_liFinalAccounts']/A");
	
	//	private By _Settings_Elem = By.xpath("//*[@id=\"ctl00_SideMenu1_liFinalAccounts\"]/ul/li[5]/a");

	//	private By Accounts_SettingsElem = By.xpath("//*[@id=\"ctl00_SideMenu1_liSettings\"]/ul/li[3]/a");
...
/*	public void Click_Final_Accounts3()
	{

		WebElement elem = getWebElement(Final_Accounts3Elem);
		...
		TestModellerLogger.FailStepWithScreenshot(m_Driver, "Click_Final_Accounts1", "Click_Final_Accounts1 failed. Unable to locate object: " + Final_Accounts2Elem.toString());
			...
			Assert.fail("Unable to locate object: " + Final_Accounts3Elem.toString());
}
...
action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
			elem.click();
			Thread.sleep(5000);
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[18]/td[2]")).getText();
			Assert.assertEquals(expected, "5100");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} 	
