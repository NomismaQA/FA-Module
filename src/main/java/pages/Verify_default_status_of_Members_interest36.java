...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/6d1d203f-cd45-41a5-913d-4613dec1e0bc
@TestModellerModule(guid = "6d1d203f-cd45-41a5-913d-4613dec1e0bc")
public class Verify_default_status_of_Members_interest36 extends BasePage
{
	public Verify_default_status_of_Members_interest36 (WebDriver driver)
	{
		super(driver);
	}
