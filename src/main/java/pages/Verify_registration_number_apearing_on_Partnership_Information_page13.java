...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/27b64c63-da69-4e2e-905b-3073c42b6c1e
@TestModellerModule(guid = "27b64c63-da69-4e2e-905b-3073c42b6c1e")
public class Verify_registration_number_apearing_on_Partnership_Information_page13 extends BasePage
{
	public Verify_registration_number_apearing_on_Partnership_Information_page13 (WebDriver driver)
	{
		super(driver);
	}
...
elem.clear();
	...
	public void Click_Filleted_Accounts()
	{
		...
		elem.click();
		String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[6]/div/table[2]/tbody/tr[1]")).getText();
