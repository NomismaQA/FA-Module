...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/c8de6c41-9cc5-4155-b3eb-e78d4768af2a
@TestModellerModule(guid = "c8de6c41-9cc5-4155-b3eb-e78d4768af2a")
public class Verify_default_status_of_average_number_of_employees_on35699 extends BasePage
{
	public Verify_default_status_of_average_number_of_employees_on35699 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By Edit2Elem = By.xpath("//A[@id='ctl00_cPH_rptrDisplayRecords_ctl03_lnkEdit']");
