...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/571f1a5e-c739-472e-9f0e-7701a3dd8e6e
@TestModellerModule(guid = "571f1a5e-c739-472e-9f0e-7701a3dd8e6e")
public class VerifydefaultstatusofGeneralInformationonStatementofFinancialPositionpage extends BasePage
{
	public VerifydefaultstatusofGeneralInformationonStatementofFinancialPositionpage (WebDriver driver)
	{
		super(driver);
	}
