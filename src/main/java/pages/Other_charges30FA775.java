...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/e8319030-075a-4e2a-b780-e2a865f05497
@TestModellerModule(guid = "e8319030-075a-4e2a-b780-e2a865f05497")
public class Other_charges30FA775 extends BasePage
{
	public Other_charges30FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[48]/td[2]")).getText();
						Assert.assertEquals(expected, "7201");
						...
						if(data.contains("7201"))
						{
							String[] dd = data.split("0");
							System.out.println(dd[0]);
							Assert.assertEquals(dd[0], "7201");
						}
						}
		} catch (Exception e) {
			// TODO Auto-generated catch block
