...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/eb268f22-9bfe-4aa7-be93-1770d88fa46f
@TestModellerModule(guid = "eb268f22-9bfe-4aa7-be93-1770d88fa46f")
public class DetailedIncomeStatementOther_charges6 extends BasePage
{
	public DetailedIncomeStatementOther_charges6 (WebDriver driver)
	{
		super(driver);
	}
