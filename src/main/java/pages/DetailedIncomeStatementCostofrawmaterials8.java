...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/767b4694-37c8-489e-81ee-50a527f3c5d1
@TestModellerModule(guid = "767b4694-37c8-489e-81ee-50a527f3c5d1")
public class DetailedIncomeStatementCostofrawmaterials8 extends BasePage
{
	public DetailedIncomeStatementCostofrawmaterials8 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By Detailed_Income_StatementElem = By.xpath("/html/body/form/main/div/div[3]/div/div[3]/a[7]");

	private By _Closing_Stock_Elem = By.xpath("//TD[contains(text(),'Closing Stock')]");
...
Thread.sleep(10000);
	...
	public boolean handlepopup3()
	{
		...
		{
			Thread.sleep(10000);
			WebElement ele = m_Driver.findElement(By.xpath("//*[@id=\"8baca373-c08f-4770-bfad-912b74a0e3db\"]"));
			WebDriverWait wait = new WebDriverWait(m_Driver, 180);
			wait.until(ExpectedConditions.visibilityOf(ele));
			ele.click();
			System.out.println(true);
...
/**
	 * Click  Closing Stock 
 * @name Click  Closing Stock 
 */
public void Click__Closing_Stock_()
{
    
	WebElement elem = getWebElement(_Closing_Stock_Elem);

	if (elem == null) {
		ExtentReportManager.failStepWithScreenshot(m_Driver, "Click__Closing_Stock_", "Click__Closing_Stock_ failed. Unable to locate object: " + _Closing_Stock_Elem.toString());

		TestModellerLogger.FailStepWithScreenshot(m_Driver, "Click__Closing_Stock_", "Click__Closing_Stock_ failed. Unable to locate object: " + _Closing_Stock_Elem.toString());

		Assert.fail("Unable to locate object: " + _Closing_Stock_Elem.toString());
    }

	elem.click();
      	

	ExtentReportManager.passStep(m_Driver, "Click__Closing_Stock_");

	TestModellerLogger.PassStep(m_Driver, "Click__Closing_Stock_");
}
}