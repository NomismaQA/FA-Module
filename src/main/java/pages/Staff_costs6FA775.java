...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/e35de2df-40f8-4124-bcca-cc5f81323deb
@TestModellerModule(guid = "e35de2df-40f8-4124-bcca-cc5f81323deb")
public class Staff_costs6FA775 extends BasePage
{
	public Staff_costs6FA775 (WebDriver driver)
	{
		super(driver);
	}
	...
	public void Click_Staff_Costs()
	{
		...
		try {
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[64]/td[2]")).getText();
						Assert.assertEquals(expected, "7263");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
