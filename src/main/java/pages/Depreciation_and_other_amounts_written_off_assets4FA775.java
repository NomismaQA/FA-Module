...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/48a4c948-4be3-4ba9-9c99-51408a0311e3
@TestModellerModule(guid = "48a4c948-4be3-4ba9-9c99-51408a0311e3")
public class Depreciation_and_other_amounts_written_off_assets4FA775 extends BasePage
{
	public Depreciation_and_other_amounts_written_off_assets4FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(3000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[92]/td[2]")).getText();
						Assert.assertEquals(expected, "7627");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
