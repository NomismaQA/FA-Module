...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/aef79a76-61f7-4341-80f0-351592cafacd
@TestModellerModule(guid = "aef79a76-61f7-4341-80f0-351592cafacd")
public class Cost_of_raw_materials_and_consumables9FA775 extends BasePage
{
	public Cost_of_raw_materials_and_consumables9FA775 (WebDriver driver)
	{
		super(driver);
	}
...
action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
			elem.click();
			Thread.sleep(5000);
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[25]/td[2]")).getText();
			Assert.assertEquals(expected, "6080");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} 	
