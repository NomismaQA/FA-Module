...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/4a530165-76b4-45d3-9b77-9629ad2f1546
@TestModellerModule(guid = "4a530165-76b4-45d3-9b77-9629ad2f1546")
public class Other_charges48FA775 extends BasePage
{
	public Other_charges48FA775 (WebDriver driver)
	{
		super(driver);
	}
...
//*/
	public void Click_Other_charges() {
		...
		try {
			...
			elem.click();
			Thread.sleep(5000);
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_rptrExpenseByDateRange_ctl25_lnkView\"]/span[1]")).getText();
			Assert.assertEquals(expected, "7212");
