...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/592c1199-1bf7-4a84-9d60-899383ef91c2
@TestModellerModule(guid = "592c1199-1bf7-4a84-9d60-899383ef91c2")
public class Cost_of_raw_materials_and_consumables5FA775 extends BasePage
{
	public Cost_of_raw_materials_and_consumables5FA775 (WebDriver driver)
	{
		super(driver);
	}
...
action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
			elem.click();
			Thread.sleep(5000);
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[19]/td[2]")).getText();
			Assert.assertEquals(expected, "5101");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} 	
