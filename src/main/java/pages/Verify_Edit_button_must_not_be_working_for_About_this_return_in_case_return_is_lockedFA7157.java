...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/adb7c041-0c25-45c7-8eea-b1153b38afaa
@TestModellerModule(guid = "adb7c041-0c25-45c7-8eea-b1153b38afaa")
public class Verify_Edit_button_must_not_be_working_for_About_this_return_in_case_return_is_lockedFA7157 extends BasePage
{
	public Verify_Edit_button_must_not_be_working_for_About_this_return_in_case_return_is_lockedFA7157 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By Submit_CT600Elem = By.xpath("//*[@id=\"ctl00_SideMenu1_FACTSubmitCT600\"]/a");

	private By UnlockElem = By.xpath("//*[@id=\"ctl00_cPH_btnUnlockHMRC\"]");

	private By About_this_returnElem = By.xpath("//*[@id=\"ctl00_SideMenu1_FACTAboutthisreturn\"]/a");
...
Thread.sleep(5000);
     ...
     * @name Click Unlock
     */
	public void Click_Unlock()
	{
        
		WebElement elem = getWebElement(UnlockElem);

		if (elem == null) {
    		ExtentReportManager.failStepWithScreenshot(m_Driver, "Click_Unlock", "Click_Unlock failed. Unable to locate object: " + UnlockElem.toString());

    		TestModellerLogger.FailStepWithScreenshot(m_Driver, "Click_Unlock", "Click_Unlock failed. Unable to locate object: " + UnlockElem.toString());

			Assert.fail("Unable to locate object: " + UnlockElem.toString());
        }

		elem.click();
          	

		ExtentReportManager.passStep(m_Driver, "Click_Unlock");

		TestModellerLogger.PassStep(m_Driver, "Click_Unlock");
	}
