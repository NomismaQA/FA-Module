...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/96bcc3f9-4d78-4eb3-a7c6-2687adc6aad2
@TestModellerModule(guid = "96bcc3f9-4d78-4eb3-a7c6-2687adc6aad2")
public class Other_charges37FA775 extends BasePage
{
	public Other_charges37FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[49]/td[2]")).getText();
						Assert.assertEquals(expected, "7203");
						...
						if(data.contains("7203"))
						{
							String[] dd = data.split("0");
							System.out.println(dd[0]);
							Assert.assertEquals(dd[0], "7203");
						}
						}
		} catch (Exception e) {
			// TODO Auto-generated catch block
