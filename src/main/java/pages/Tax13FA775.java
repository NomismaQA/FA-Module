...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/48c33418-835f-4727-a869-5ced4d9f271e
@TestModellerModule(guid = "48c33418-835f-4727-a869-5ced4d9f271e")
public class Tax13FA775 extends BasePage
{
	public Tax13FA775 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By TaxElem = By.xpath("//*[@id=\"disDiv\"]/div/div[9]/div/table[2]/tbody/tr[25]/td[3]/a/ix:nonfraction");
...
//			Assert.assertEquals(expected, "(14,710)");
     ...
     * @name Click Tax
     */
	public void Click_Tax()
	{
        
		try {
			//WebElement elem = getWebElement(TaxElem);
			/*
			 * if (elem == null) { ExtentReportManager.failStepWithScreenshot(m_Driver,
			 * "Click_Tax", "Click_Tax failed. Unable to locate object: " +
			 * TaxElem.toString());
			 * 
			 * TestModellerLogger.FailStepWithScreenshot(m_Driver, "Click_Tax",
			 * "Click_Tax failed. Unable to locate object: " + TaxElem.toString());
			 * 
			 * Assert.fail("Unable to locate object: " + TaxElem.toString()); }
			 */
			
			System.out.println();
			ArrayList<String>tabs= new ArrayList<String>(m_Driver.getWindowHandles());
			m_Driver.switchTo().window(tabs.get(3));
			String expected = m_Driver.findElement(By.xpath("(//*[@class=\"MediumSmallPopup-Small cboxElement\"])[23]")).getText();
			Thread.sleep(5000);
			System.out.println(expected);
			String actualdata = m_Driver.findElement(By.xpath("(//*[@class=\"MediumSmallPopup-Small cboxElement\"])[23]")).getText();
		...
		ExtentReportManager.passStep(m_Driver, "Click_Tax");

		TestModellerLogger.PassStep(m_Driver, "Click_Tax");
	}
}