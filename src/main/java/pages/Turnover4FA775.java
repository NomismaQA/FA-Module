...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/0a8d107b-fab5-48d5-b1ce-0a8e16cf139e
@TestModellerModule(guid = "0a8d107b-fab5-48d5-b1ce-0a8e16cf139e")
public class Turnover4FA775 extends BasePage
{
	public Turnover4FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(3000);
			elem.click();
			Thread.sleep(5000);
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_divScroll\"]/div/table/tbody[2]/tr[4]")).getText();
			Assert.assertEquals(expected, "4000	Sales				(£140,000.00)");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
