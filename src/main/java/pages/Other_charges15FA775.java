...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/67c9164c-8a6e-4fe3-aca6-765a2bbef446
@TestModellerModule(guid = "67c9164c-8a6e-4fe3-aca6-765a2bbef446")
public class Other_charges15FA775 extends BasePage
{
	public Other_charges15FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[72]/td[2]")).getText();
						Assert.assertEquals(expected, "7281");
						...
						if(data.contains("7281"))
						{
							String[] dd = data.split("0");
							System.out.println(dd[0]);
							Assert.assertEquals(dd[0], "7281");
						}
						}
		} catch (Exception e) {
			// TODO Auto-generated catch block
