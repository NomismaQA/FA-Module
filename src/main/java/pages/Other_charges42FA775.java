...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/e780b173-62c3-4868-8e7f-591f9190719d
@TestModellerModule(guid = "e780b173-62c3-4868-8e7f-591f9190719d")
public class Other_charges42FA775 extends BasePage
{
	public Other_charges42FA775 (WebDriver driver)
	{
		super(driver);
	}
...
//*/
	public void Click_Other_charges() {
		...
		try {
			...
			elem.click();
			Thread.sleep(5000);
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_rptrExpenseByDateRange_ctl52_lnkView\"]/span[1]")).getText();
			Assert.assertEquals(expected, "7510");
