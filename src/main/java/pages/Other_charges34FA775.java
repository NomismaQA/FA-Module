...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/e83f0cf8-508e-4bd3-95aa-72331f701426
@TestModellerModule(guid = "e83f0cf8-508e-4bd3-95aa-72331f701426")
public class Other_charges34FA775 extends BasePage
{
	public Other_charges34FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[54]/td[2]")).getText();
						Assert.assertEquals(expected, "7210");
						...
						if(data.contains("7210"))
						{
							String[] dd = data.split("0");
							System.out.println(dd[0]);
							Assert.assertEquals(dd[0], "7210");
						}
						}
		} catch (Exception e) {
			// TODO Auto-generated catch block
