...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/fbf78b88-8349-4418-be35-f97c2f82a587
@TestModellerModule(guid = "fbf78b88-8349-4418-be35-f97c2f82a587")
public class DetailedIncomeStatementOther_charges34 extends BasePage
{
	public DetailedIncomeStatementOther_charges34 (WebDriver driver)
	{
		super(driver);
	}
