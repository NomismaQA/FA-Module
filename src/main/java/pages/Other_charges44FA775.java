...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/d45463a6-7386-46b6-8709-92f70a701623
@TestModellerModule(guid = "d45463a6-7386-46b6-8709-92f70a701623")
public class Other_charges44FA775 extends BasePage
{
	public Other_charges44FA775 (WebDriver driver)
	{
		super(driver);
	}
...
//*/
	public void Click_Other_charges() {
		...
		try {
			...
			elem.click();
			Thread.sleep(5000);
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_rptrExpenseByDateRange_ctl02_lnkView\"]/span[1]")).getText();
			Assert.assertEquals(expected, "7005");
