...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/16a4b7da-bf95-410c-aa61-57982d46976b
@TestModellerModule(guid = "16a4b7da-bf95-410c-aa61-57982d46976b")
public class Other_charges1FA775 extends BasePage
{
	public Other_charges1FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			Actions action= new Actions(m_Driver);
 			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
 						elem.click();
						Thread.sleep(5000);
 						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[38]/td[2]")).getText();
