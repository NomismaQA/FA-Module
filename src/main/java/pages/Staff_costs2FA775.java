...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/3b536c90-c134-4387-85a6-3b9f8c62e133
@TestModellerModule(guid = "3b536c90-c134-4387-85a6-3b9f8c62e133")
public class Staff_costs2FA775 extends BasePage
{
	public Staff_costs2FA775 (WebDriver driver)
	{
		super(driver);
	}
  	...
  	public void Click_Staff_Costs()
  	{
  		...
  		try {
  			...
  			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
  						elem.click();
  						Thread.sleep(5000);
  						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[22]/td[2]")).getText();
  						Assert.assertEquals(expected, "6010");
  		} catch (Exception e) {
  			// TODO Auto-generated catch block
  			e.printStackTrace();
  		}
