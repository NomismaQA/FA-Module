...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/7a84b2ad-b16e-4344-a293-ed9586df11e7
@TestModellerModule(guid = "7a84b2ad-b16e-4344-a293-ed9586df11e7")
public class Turnover2FA775 extends BasePage
{
	public Turnover2FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(3000);
			...
			Assert.assertEquals(expected, "4021	Flat rate saving				(£72,235.00)");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
