...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/3e0f82ab-772a-4bd2-a366-3baebdd3f80f
@TestModellerModule(guid = "3e0f82ab-772a-4bd2-a366-3baebdd3f80f")
public class DetailedIncomeStatementSundry_Income extends BasePage
{
	public DetailedIncomeStatementSundry_Income (WebDriver driver)
	{
		super(driver);
	}
