...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/27f92534-c5a9-453e-930d-af7c96ff69b8
@TestModellerModule(guid = "27f92534-c5a9-453e-930d-af7c96ff69b8")
public class Verify_accountants_appearing_on_company_information_pageFA69720 extends BasePage
{
	public Verify_accountants_appearing_on_company_information_pageFA69720 (WebDriver driver)
	{
		super(driver);
	}
...
elem.clear();
	...
	public void Click_Filleted_Accounts()
	{
		...
		elem.click();
		String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[6]/div/table[2]/tbody/tr[61]")).getText();
