...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/176bbf99-9ed4-40ff-831e-a8836337e98d
@TestModellerModule(guid = "176bbf99-9ed4-40ff-831e-a8836337e98d")
public class Verify_header_appearance_on_Company_Information_pageFA69612 extends BasePage
{
	public Verify_header_appearance_on_Company_Information_pageFA69612 (WebDriver driver)
	{
		super(driver);
	}
...
//				"For the year ended 04 April 2021");
		...
		Assert.assertEquals(str[2],"For the year ended 04 April 2021");
