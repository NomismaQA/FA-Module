...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/50c3f2b1-d05c-4d5b-8313-5bf322a3e076
@TestModellerModule(guid = "50c3f2b1-d05c-4d5b-8313-5bf322a3e076")
public class Other_charges28FA775 extends BasePage
{
	public Other_charges28FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[80]/td[2]")).getText();
						Assert.assertEquals(expected, "7505");
						...
						if(data.contains("7505"))
						{
							String[] dd = data.split("0");
							System.out.println(dd[0]);
							Assert.assertEquals(dd[0], "7505");
						}
						}
		} catch (Exception e) {
			// TODO Auto-generated catch block
