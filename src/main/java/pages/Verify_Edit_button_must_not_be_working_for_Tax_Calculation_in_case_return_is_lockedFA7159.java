...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/156825e3-e4f2-4494-bb6a-33d542bffcd2
@TestModellerModule(guid = "156825e3-e4f2-4494-bb6a-33d542bffcd2")
public class Verify_Edit_button_must_not_be_working_for_Tax_Calculation_in_case_return_is_lockedFA7159 extends BasePage
{
	public Verify_Edit_button_must_not_be_working_for_Tax_Calculation_in_case_return_is_lockedFA7159 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By About_this_returnElem = By.xpath("//A[contains(text(),'About this return')]");

	private By _Edit_Elem = By.xpath("//A[@id='ctl00_cpHeaderRight_btnEdit']");

	private By About_this_return_1Elem = By.xpath("//SPAN[@id='__tab_ctl00_cPH_ctl00_TabPanel3']");

	private By Clause_No_80Elem = By.xpath("//INPUT[@id='ctl00_cPH_ctl00_TabPanel3_chkThisPeriodAccounts']");
...
Thread.sleep(10000);
	...
	/**
 	 * Click About this return
     * @name Click About this return
     */
	public void Click_About_this_return()
	{
        
		WebElement elem = getWebElement(About_this_returnElem);

		if (elem == null) {
    		ExtentReportManager.failStepWithScreenshot(m_Driver, "Click_About_this_return", "Click_About_this_return failed. Unable to locate object: " + About_this_returnElem.toString());

    		TestModellerLogger.FailStepWithScreenshot(m_Driver, "Click_About_this_return", "Click_About_this_return failed. Unable to locate object: " + About_this_returnElem.toString());

			Assert.fail("Unable to locate object: " + About_this_returnElem.toString());
        }

		elem.click();
          	

		ExtentReportManager.passStep(m_Driver, "Click_About_this_return");

		TestModellerLogger.PassStep(m_Driver, "Click_About_this_return");
	}
     ...
     * @name Click About this return
     */
	public void Click_About_this_return_1()
	{
        
		WebElement elem = getWebElement(About_this_return_1Elem);

		if (elem == null) {
    		ExtentReportManager.failStepWithScreenshot(m_Driver, "Click_About_this_return_1", "Click_About_this_return_1 failed. Unable to locate object: " + About_this_return_1Elem.toString());

    		TestModellerLogger.FailStepWithScreenshot(m_Driver, "Click_About_this_return_1", "Click_About_this_return_1 failed. Unable to locate object: " + About_this_return_1Elem.toString());

			Assert.fail("Unable to locate object: " + About_this_return_1Elem.toString());
        }

		elem.click();
          	

		ExtentReportManager.passStep(m_Driver, "Click_About_this_return_1");

		TestModellerLogger.PassStep(m_Driver, "Click_About_this_return_1");
	}

     
	/**
 	 * Click Clause No. 80
     * @name Click Clause No. 80
     */
	public void Click_Clause_No_80()
	{
        
		WebElement elem = getWebElement(Clause_No_80Elem);

		if (elem == null) {
    		ExtentReportManager.failStepWithScreenshot(m_Driver, "Click_Clause_No_80", "Click_Clause_No_80 failed. Unable to locate object: " + Clause_No_80Elem.toString());

    		TestModellerLogger.FailStepWithScreenshot(m_Driver, "Click_Clause_No_80", "Click_Clause_No_80 failed. Unable to locate object: " + Clause_No_80Elem.toString());

			Assert.fail("Unable to locate object: " + Clause_No_80Elem.toString());
        }

		elem.click();
          	

		ExtentReportManager.passStep(m_Driver, "Click_Clause_No_80");

		TestModellerLogger.PassStep(m_Driver, "Click_Clause_No_80");
	}
}