...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/e2c852b9-d0d3-41fa-9527-856f61e4571d
@TestModellerModule(guid = "e2c852b9-d0d3-41fa-9527-856f61e4571d")
public class Other_charges6FA775 extends BasePage
{
	public Other_charges6FA775 (WebDriver driver)
	{
		super(driver);
	}
...
//  	 * Click Other_charges
  ...
  Thread.sleep(2000);
  			...
  			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
  						elem.click();
  						Thread.sleep(5000);
  						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[85]/td[2]")).getText();
  						Assert.assertEquals(expected, "7518");
  		} catch (Exception e) {
  			// TODO Auto-generated catch block
  			e.printStackTrace();
  		}
