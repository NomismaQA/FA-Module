...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/a4d48294-c4d0-4e8e-83fd-dd85ff389cb3
@TestModellerModule(guid = "a4d48294-c4d0-4e8e-83fd-dd85ff389cb3")
public class DetailedIncomeStatementOther_charges extends BasePage
{
	public DetailedIncomeStatementOther_charges (WebDriver driver)
	{
		super(driver);
	}
