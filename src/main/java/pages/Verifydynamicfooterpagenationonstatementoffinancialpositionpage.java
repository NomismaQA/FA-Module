...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/efdafad2-d66c-4562-83f8-e547d04d3c7a
@TestModellerModule(guid = "efdafad2-d66c-4562-83f8-e547d04d3c7a")
public class Verifydynamicfooterpagenationonstatementoffinancialpositionpage extends BasePage
{
	public Verifydynamicfooterpagenationonstatementoffinancialpositionpage (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _Clients_Elem = By.xpath("//A[@href='Company.aspx']");
	...
	private By _ABC_LLPElem = By.xpath("//TD[@style='cursor: pointer;']");
	...
	public void GoToUrl()
	{
		m_Driver.get("http://sandbox4.nomismasolution.co.uk/AccountUI/FinalAccountPreview.aspx?FYCode=9061&CompanyCode=6837&t=Full");

		ExtentReportManager.passStepWithScreenshot(m_Driver, "Go to URL", "Go to URL - http://sandbox4.nomismasolution.co.uk/AccountUI/FinalAccountPreview.aspx?FYCode=9061&CompanyCode=6837&t=Full");
		
		TestModellerLogger.PassStepWithScreenshot(m_Driver, "Go to URL", "Go to URL - http://sandbox4.nomismasolution.co.uk/AccountUI/FinalAccountPreview.aspx?FYCode=9061&CompanyCode=6837&t=Full");
	}
   ...
   public void AssertUrl()
    {
        ...
        String expectedUrl = "http://sandbox4.nomismasolution.co.uk/AccountUI/FinalAccountPreview.aspx?FYCode=9061&CompanyCode=6837&t=Full";

        if (!currentUrl.equals("http://sandbox4.nomismasolution.co.uk/AccountUI/FinalAccountPreview.aspx?FYCode=9061&CompanyCode=6837&t=Full")) {
