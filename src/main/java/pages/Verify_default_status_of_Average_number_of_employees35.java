...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/09876cc8-2462-400c-ada1-c7f3c6a9267a
@TestModellerModule(guid = "09876cc8-2462-400c-ada1-c7f3c6a9267a")
public class Verify_default_status_of_Average_number_of_employees35 extends BasePage
{
	public Verify_default_status_of_Average_number_of_employees35 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(1000);
	...
	public void Click_Statement_of_Financial_Position()
	{
		...
		Assert.assertEquals(expected, "(2) Average number of employees");
