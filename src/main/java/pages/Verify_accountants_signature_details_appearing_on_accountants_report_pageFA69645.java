...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/18d3c0c3-fe5e-4ddd-b552-3613fc8fe77a
@TestModellerModule(guid = "18d3c0c3-fe5e-4ddd-b552-3613fc8fe77a")
public class Verify_accountants_signature_details_appearing_on_accountants_report_pageFA69645 extends BasePage
{
	public Verify_accountants_signature_details_appearing_on_accountants_report_pageFA69645 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(10000);
	...
	public void Click_Full_Accounts()
	{
		...
		Assert.assertEquals(expected, "Accountant ABC Associates");  	
