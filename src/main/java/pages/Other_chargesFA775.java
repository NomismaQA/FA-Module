...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/88ac39d7-8649-47da-9f08-247618f578bb
@TestModellerModule(guid = "88ac39d7-8649-47da-9f08-247618f578bb")
public class Other_chargesFA775 extends BasePage
{
	public Other_chargesFA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[43]/td[2]")).getText();
						Assert.assertEquals(expected, "7031");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
