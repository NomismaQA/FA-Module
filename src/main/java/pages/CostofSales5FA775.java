...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/80c4e6c0-bbe6-4e1b-9ac4-41a87c44e114
@TestModellerModule(guid = "80c4e6c0-bbe6-4e1b-9ac4-41a87c44e114")
public class CostofSales5FA775 extends BasePage
{
	public CostofSales5FA775 (WebDriver driver)
	{
		super(driver);
	}
 ...
 */
 ...
 Thread.sleep(7000);
 			...
 			Assert.assertEquals(expected, "6000	Gross wages	247.00");
 		} catch (Exception e) {
 			// TODO Auto-generated catch block
 			e.printStackTrace();
 		}
