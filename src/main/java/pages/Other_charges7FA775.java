...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/6e658402-50b4-463e-9170-96aa7be4c9da
@TestModellerModule(guid = "6e658402-50b4-463e-9170-96aa7be4c9da")
public class Other_charges7FA775 extends BasePage
{
	public Other_charges7FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[86]/td[2]")).getText();
						Assert.assertEquals(expected, "7519");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
