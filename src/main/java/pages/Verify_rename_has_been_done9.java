...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/fede9dac-2913-4ab0-bb6c-7a96dcdd5a7a
@TestModellerModule(guid = "fede9dac-2913-4ab0-bb6c-7a96dcdd5a7a")
public class Verify_rename_has_been_done9 extends BasePage
{
	public Verify_rename_has_been_done9 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			CopyOnWriteArrayList<String>list=new CopyOnWriteArrayList<String>();
				...
				int count=0;
				 List<WebElement> data = m_Driver.findElements(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[4]/div/table[2]/tbody"));
