...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/ff2fc613-a567-46c1-b47d-e29aceb16e92
@TestModellerModule(guid = "ff2fc613-a567-46c1-b47d-e29aceb16e92")
public class Other_charges47FA775 extends BasePage
{
	public Other_charges47FA775 (WebDriver driver)
	{
		super(driver);
	}
...
//*/
	public void Click_Other_charges() {
		...
		try {
			...
			elem.click();
			Thread.sleep(5000);
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_rptrExpenseByDateRange_ctl04_lnkView\"]/span[1]")).getText();
			Assert.assertEquals(expected, "7010");
