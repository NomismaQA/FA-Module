...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/f41dccb3-7882-4f81-8e53-fc7565609cdf
@TestModellerModule(guid = "f41dccb3-7882-4f81-8e53-fc7565609cdf")
public class DetailedIncomeStatementOther_charges28 extends BasePage
{
	public DetailedIncomeStatementOther_charges28 (WebDriver driver)
	{
		super(driver);
	}
