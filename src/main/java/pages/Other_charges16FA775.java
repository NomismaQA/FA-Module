...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/91aecd0c-02e2-430b-a939-9ace00de0892
@TestModellerModule(guid = "91aecd0c-02e2-430b-a939-9ace00de0892")
public class Other_charges16FA775 extends BasePage
{
	public Other_charges16FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[71]/td[2]")).getText();
						Assert.assertEquals(expected, "7280");
						...
						if(data.contains("7280"))
						{
							String[] dd = data.split("0");
							System.out.println(dd[0]);
							Assert.assertEquals(dd[0], "7280");
						}
						}
		} catch (Exception e) {
			// TODO Auto-generated catch block
