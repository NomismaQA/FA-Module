...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/93e75482-eb06-4dc6-b665-73d983e9431b
@TestModellerModule(guid = "93e75482-eb06-4dc6-b665-73d983e9431b")
public class Other_charges46FA775 extends BasePage
{
	public Other_charges46FA775 (WebDriver driver)
	{
		super(driver);
	}
...
//	private By Other_chargesElem = By.xpath("//A[@href='Popup/FAViewTrialBalance.aspx?StandardCode=2&MainSection=PL&Year=C&Section=OTHERCHARGES&FYCode=52443&CompanyCode=13249']");
	...
	public void GoToUrl() {
		...
		ExtentReportManager.passStepWithScreenshot(m_Driver, "Go to URL",
				"http://sandbox4.nomismasolution.co.uk/ssoui/Signin.aspx?token=f5b917d4-181c-41a1-8ab7-ae93557a5a58");
...
//	}
	...
	public void Click_Income_Statement_Page() {
		...
		try {
			...
			if (elem == null) {
				ExtentReportManager.failStepWithScreenshot(m_Driver, "Click_Income_Statement_Page",
						"Click_Income_Statement_Page failed. Unable to locate object: "
								+ Income_Statement_PageElem.toString());

				TestModellerLogger.FailStepWithScreenshot(m_Driver, "Click_Income_Statement_Page",
						"Click_Income_Statement_Page failed. Unable to locate object: "
								+ Income_Statement_PageElem.toString());
...
//*/
	public void Click_Other_charges() {
		...
		try {
			...
			if (elem == null) {
				ExtentReportManager.failStepWithScreenshot(m_Driver, "Click_Other_charges",
						"Click_Other_charges failed. Unable to locate object: " + Other_chargesElem.toString());

				TestModellerLogger.FailStepWithScreenshot(m_Driver, "Click_Other_charges",
						"Click_Other_charges failed. Unable to locate object: " + Other_chargesElem.toString());
			...
			elem.click();
			Thread.sleep(5000);
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_rptrExpenseByDateRange_ctl08_lnkView\"]/span[1]")).getText();
			Assert.assertEquals(expected, "7016");
			...
			} else
			{
				...
				if (data.contains("7268")) {
					String[] dd = data.split("0");
					System.out.println(dd[0]);
					Assert.assertEquals(dd[0], "7268");
				}
			}
		} catch (Exception e) {
			// TODO Auto-generated catch block
