...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/cb2f41b1-e90f-4e11-abf6-b6ff127dd471
@TestModellerModule(guid = "cb2f41b1-e90f-4e11-abf6-b6ff127dd471")
public class Other_charges8FA775 extends BasePage
{
	public Other_charges8FA775 (WebDriver driver)
	{
		super(driver);
	}
...
//  	 * Click Other_charges
  ...
  Thread.sleep(2000);
  			...
  			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
  						elem.click();
  						Thread.sleep(5000);
  						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[39]/td[2]")).getText();
  						Assert.assertEquals(expected, "7020");
  		} catch (Exception e) {
  			// TODO Auto-generated catch block
  			e.printStackTrace();
  		}
