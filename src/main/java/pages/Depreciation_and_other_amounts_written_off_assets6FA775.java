...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/9573ead5-1c83-4af2-9bda-6c5dffcefb3a
@TestModellerModule(guid = "9573ead5-1c83-4af2-9bda-6c5dffcefb3a")
public class Depreciation_and_other_amounts_written_off_assets6FA775 extends BasePage
{
	public Depreciation_and_other_amounts_written_off_assets6FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(3000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[93]/td[2]")).getText();
						Assert.assertEquals(expected, "7628");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
