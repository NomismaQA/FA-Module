...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/86f97f35-7484-4cd0-8080-2f6e996ce5aa
@TestModellerModule(guid = "86f97f35-7484-4cd0-8080-2f6e996ce5aa")
public class Tax6FA775 extends BasePage
{
	public Tax6FA775 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _Reports_Elem = By.xpath("//*[@id=\"ctl00_SideMenu1_reportMenu\"]/a/span");
