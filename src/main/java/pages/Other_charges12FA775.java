...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/3abdc013-1aec-43eb-a68e-a659461891cc
@TestModellerModule(guid = "3abdc013-1aec-43eb-a68e-a659461891cc")
public class Other_charges12FA775 extends BasePage
{
	public Other_charges12FA775 (WebDriver driver)
	{
		super(driver);
	}
	...
	public void Click_Income_Statement_Page()
	{
		...
		try {
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[73]/td[2]")).getText();
						Assert.assertEquals(expected, "7283");
