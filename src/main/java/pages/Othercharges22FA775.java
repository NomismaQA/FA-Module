...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/6869e44d-dd9f-4f53-ad47-1c037042c4a7
@TestModellerModule(guid = "6869e44d-dd9f-4f53-ad47-1c037042c4a7")
public class Othercharges22FA775 extends BasePage
{
	public Othercharges22FA775 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By Add_Financial_YearElem = By.xpath("//*[@id=\"ctl00_ddlFinancialYear\"]");
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[51]/td[2]")).getText();
						Assert.assertEquals(expected, "7205");
						...
						if(data.contains("7205"))
						{
							String[] dd = data.split("0");
							System.out.println(dd[0]);
							Assert.assertEquals(dd[0], "7205");
						}
						}
		} catch (Exception e) {
			// TODO Auto-generated catch block
