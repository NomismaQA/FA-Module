...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/1a6d547b-8591-42a2-b244-d62b4187b2ee
@TestModellerModule(guid = "1a6d547b-8591-42a2-b244-d62b4187b2ee")
public class Verifymember extends BasePage
{
	public Verifymember (WebDriver driver)
	{
		super(driver);
	}
	...
	private By ctl00cPHtxtAddress1Elem = By.xpath("//*[@id=\"ctl00_cPH_pnlControls\"]/div/div[2]/div[1]/div[1]/label//following::input[@name='ctl00$cPH$txtAddress1']");
	...
	private By Save1Elem = By.xpath("//*[@id='ctl00_cphFooter_btnSave']");
	...
	private By Enter_ctl00cPHtxtAddress1 = By.xpath("//INPUT[@name='ctl00$cPH$txtAddress1']");

	private By Enter_ctl00cPHtxtAddress2 = By.xpath("//INPUT[@name='ctl00$cPH$txtAddress2']");

	private By Enter_ctl00cPHtxtAddress3 = By.xpath("//INPUT[@name='ctl00$cPH$txtAddress3']");

	private By Enter_ctl00cPHtxtAddress4 = By.xpath("//INPUT[@name='ctl00$cPH$txtAddress4']");

	private By Enter_ctl00cPHtxtRegFAPostCode = By.xpath("//INPUT[@name='ctl00$cPH$txtRegFAPostCode']");

	private By Save2Elem = By.xpath("//*[@id=\"ctl00_cphFooter_btnSave\"]");

	private By Final_Accounts_1Elem = By.xpath("//*[@id=\\\"ctl00_SideMenu1_liFinalAccounts\\\"]/a/span");
	...
	public void GoToUrl()
	{
		m_Driver.get("http://sandbox4.nomismasolution.co.uk/ssoui/Signin.aspx?token=7beec506-14fb-45cb-bf66-7cdcc71edc3b");

		ExtentReportManager.passStepWithScreenshot(m_Driver, "Go to URL", "http://sandbox4.nomismasolution.co.uk/ssoui/Signin.aspx?token=7beec506-14fb-45cb-bf66-7cdcc71edc3b");
		
		TestModellerLogger.PassStepWithScreenshot(m_Driver, "Go to URL", "http://sandbox4.nomismasolution.co.uk/ssoui/Signin.aspx?token=7beec506-14fb-45cb-bf66-7cdcc71edc3b");
	}
   ...
   public void AssertUrl()
    {
        ...
        String expectedUrl = "http://sandbox4.nomismasolution.co.uk/ssoui/Signin.aspx?token=7beec506-14fb-45cb-bf66-7cdcc71edc3b";

        if (!currentUrl.equals("http://sandbox4.nomismasolution.co.uk/ssoui/Signin.aspx?token=7beec506-14fb-45cb-bf66-7cdcc71edc3b")) {
...
Thread.sleep(1000);
     ...
     */
 	public void ctl00cPHtxtAddress1(String ctl00cPHtxtAddress1)
 	{
     ...
     */
 	public void ctl00cPHtxtAddress2(String ctl00cPHtxtAddress2)
 	{
...
elem.clear();
     ...
     */
 	public void ctl00cPHtxtAddress3(String ctl00cPHtxtAddress3)
 	{
     ...
     */
 	public void ctl00cPHtxtAddress4(String ctl00cPHtxtAddress4)
 	{
...
elem.clear();
 	...
 	public void ctl00cPHtxtRegFAPostCode(String Enter_ctl00cPHtxtRegFAPostCode)
 	{
...
elem.clear();
			elem.sendKeys(Enter_ctl00cPHtxtRegFAPostCode);
  		...
  		ExtentReportManager.passStep(m_Driver, "Enter_ctl00cPHtxtRegFAPostCode " + Enter_ctl00cPHtxtRegFAPostCode);

  		TestModellerLogger.PassStep(m_Driver, "Enter_ctl00cPHtxtRegFAPostCode " + Enter_ctl00cPHtxtRegFAPostCode);
 	}
...
Thread.sleep(1000);
	...
	public void Enter_ctl00cPHtxtAddress1(String Enter_ctl00cPHtxtAddress1)
 	{
		...
		try {
			...
			elem.sendKeys(Enter_ctl00cPHtxtAddress1);
			JavascriptExecutor je = (JavascriptExecutor)m_Driver;
			je.executeScript("arguments[0].scrollIntoView(true);",elem);
			m_Driver.switchTo().defaultContent();
		} catch (Exception e) {
  		...
  		ExtentReportManager.passStep(m_Driver, "Enter_ctl00cPHtxtAddress1 " + Enter_ctl00cPHtxtAddress1);

  		TestModellerLogger.PassStep(m_Driver, "Enter_ctl00cPHtxtAddress1 " + Enter_ctl00cPHtxtAddress1);
 	}
     ...
     */
 	public void Enter_ctl00cPHtxtRegFAPostCode(String Enter_ctl00cPHtxtRegFAPostCode)
 	{
