...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/a0154ad7-0fc6-4a17-9a95-1ef2335f5392
@TestModellerModule(guid = "a0154ad7-0fc6-4a17-9a95-1ef2335f5392")
public class Other_charges39FA775 extends BasePage
{
	public Other_charges39FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[40]/td[2]")).getText();
						Assert.assertEquals(expected, "7021");
						...
						if(data.contains("7021"))
						{
							String[] dd = data.split("0");
							System.out.println(dd[0]);
							Assert.assertEquals(dd[0], "7021");
						}
						}
		} catch (Exception e) {
			// TODO Auto-generated catch block
