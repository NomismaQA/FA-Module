...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/187d7e6c-bd41-446e-a3ba-e9da01c60c21
@TestModellerModule(guid = "187d7e6c-bd41-446e-a3ba-e9da01c60c21")
public class Verify_header_appearance_on_directors_report_pageFA69623 extends BasePage
{
	public Verify_header_appearance_on_directors_report_pageFA69623 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(10000);
	...
	public void Click_Full_Accounts()
	{
		...
		elem.click();
		String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[8]/div/table[1]/tbody/tr/td")).getText();
...
////				"For the year ended 4 April 2021");
		...
		Assert.assertEquals(str[1],"Directors' Report");
