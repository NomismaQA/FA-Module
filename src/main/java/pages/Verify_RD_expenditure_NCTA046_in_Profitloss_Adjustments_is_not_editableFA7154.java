...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/1ef7ea86-c12f-439b-bccc-e403cfa05004
@TestModellerModule(guid = "1ef7ea86-c12f-439b-bccc-e403cfa05004")
public class Verify_RD_expenditure_NCTA046_in_Profitloss_Adjustments_is_not_editableFA7154 extends BasePage
{
	public Verify_RD_expenditure_NCTA046_in_Profitloss_Adjustments_is_not_editableFA7154 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By CT_Adjustments_SettingsElem = By.xpath("//*[@id=\"ctl00_SideMenu1_CTFinalAccountAdjustments\"]/a");

	private By _Edit_Elem = By.xpath("//*[@id=\"ctl00_cpHeaderRight_btnEdit\"]");

	private By NAC_046Elem = By.xpath("//INPUT[@name='ctl00$cPH$tbContainer$TabPanel1$rptProfit$ctl19$txtBalance']");
...
Thread.sleep(10000);
     ...
     * @name Enter NAC_046
     */
 	public void Enter_NAC_046(String NAC_046)
 	{
 	    
 		WebElement elem = getWebElement(NAC_046Elem);

 		if (elem == null) {
    		ExtentReportManager.failStepWithScreenshot(m_Driver, "Enter_NAC_046", "Enter_NAC_046 failed. Unable to locate object: " + NAC_046Elem.toString());

    		TestModellerLogger.FailStepWithScreenshot(m_Driver, "Enter_NAC_046", "Enter_NAC_046 failed. Unable to locate object: " + NAC_046Elem.toString());

 			Assert.fail("Unable to locate object: " + NAC_046Elem.toString());
         }
 		JavascriptExecutor je = (JavascriptExecutor)m_Driver;
		je.executeScript("arguments[0].scrollIntoView(true);",elem);

 		elem.sendKeys(NAC_046);
 		
 		
  		ExtentReportManager.passStep(m_Driver, "Enter_NAC_046 " + NAC_046);

  		TestModellerLogger.PassStep(m_Driver, "Enter_NAC_046 " + NAC_046);
 	}
