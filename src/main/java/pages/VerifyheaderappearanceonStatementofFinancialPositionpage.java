...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/05058271-01ad-4986-a6e4-54625dad830a
@TestModellerModule(guid = "05058271-01ad-4986-a6e4-54625dad830a")
public class VerifyheaderappearanceonStatementofFinancialPositionpage extends BasePage
{
	public VerifyheaderappearanceonStatementofFinancialPositionpage (WebDriver driver)
	{
		super(driver);
	}
	...
	private By Cover_PageElem = By.xpath("//*[@id=\"ctl00_cPH_listDivLLPFRS105Full\"]/a[6]");
