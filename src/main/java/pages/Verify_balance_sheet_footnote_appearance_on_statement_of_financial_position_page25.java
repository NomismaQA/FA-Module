...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/ba6bc30b-e2ae-4a4f-b191-23848fbba37c
@TestModellerModule(guid = "ba6bc30b-e2ae-4a4f-b191-23848fbba37c")
public class Verify_balance_sheet_footnote_appearance_on_statement_of_financial_position_page25 extends BasePage
{
	public Verify_balance_sheet_footnote_appearance_on_statement_of_financial_position_page25 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(5000);
	...
	public void Click_Partnership_Information()
	{
		...
		elem.click();
		String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[8]/div/table[2]/tbody/tr[19]/td/table/tbody/tr[1]/td")).getText();
