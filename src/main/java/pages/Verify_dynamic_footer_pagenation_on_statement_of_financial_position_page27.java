...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/38aeb677-48a1-4b1b-9368-4b5fff143c89
@TestModellerModule(guid = "38aeb677-48a1-4b1b-9368-4b5fff143c89")
public class Verify_dynamic_footer_pagenation_on_statement_of_financial_position_page27 extends BasePage
{
	public Verify_dynamic_footer_pagenation_on_statement_of_financial_position_page27 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(5000);
	...
	public void Click_Filleted_Accounts()
	{
		...
		elem.click();
		String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[6]/div/div")).getText();
