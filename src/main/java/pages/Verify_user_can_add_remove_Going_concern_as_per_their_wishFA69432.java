...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/f7de319d-ff87-41fa-8d07-df0b239ca88b
@TestModellerModule(guid = "f7de319d-ff87-41fa-8d07-df0b239ca88b")
public class Verify_user_can_add_remove_Going_concern_as_per_their_wishFA69432 extends BasePage
{
	public Verify_user_can_add_remove_Going_concern_as_per_their_wishFA69432 (WebDriver driver)
	{
		super(driver);
	}
