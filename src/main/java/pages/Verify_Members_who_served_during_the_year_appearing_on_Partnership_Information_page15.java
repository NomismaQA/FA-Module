...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/0f453b2e-f599-488f-b99b-605d2f1fd8ee
@TestModellerModule(guid = "0f453b2e-f599-488f-b99b-605d2f1fd8ee")
public class Verify_Members_who_served_during_the_year_appearing_on_Partnership_Information_page15 extends BasePage
{
	public Verify_Members_who_served_during_the_year_appearing_on_Partnership_Information_page15 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By ctl00cPHtxtAddress1Elem = By.xpath("//div[@class='col-sm-7 col-xs-7']/INPUT[@name='ctl00$cPH$txtAddress1'][@class='form-control']");
	...
	private By ctl00cPHtxtPostCodeElem = By.xpath("//INPUT[@name='ctl00$cPH$txtPostCode']");
	...
	private By ctl00cPHtxtAddress1_1Elem = By.xpath("//INPUT[@name='ctl00$cPH$txtAddress1']");

	private By ctl00cPHtxtAddress2_1Elem = By.xpath("//INPUT[@name='ctl00$cPH$txtAddress2']");

	private By ctl00cPHtxtAddress3_1Elem = By.xpath("//INPUT[@name='ctl00$cPH$txtAddress3']");

	private By ctl00cPHtxtAddress4_1Elem = By.xpath("//INPUT[@name='ctl00$cPH$txtAddress4']");
...
Thread.sleep(5000);
     ...
     */
 	public void Enter_ctl00cPHtxtAddress1(String ctl00cPHtxtAddress1)
 	{
		...
		try {
			...
			/*
			 * JavascriptExecutor jsExecutor = (JavascriptExecutor) m_Driver; //set the text
			 * jsExecutor.executeScript(
			 * "document.getElementById('ctl00_cPH_txtAddress1').value='"+
			 * ctl00cPHtxtAddress1+"'");
			 * 
			 * elem.sendKeys(ctl00cPHtxtAddress1); Thread.sleep(5000); JavascriptExecutor je
     ...
     */
 	public void Enter_ctl00cPHtxtAddress2(String ctl00cPHtxtAddress2)
 	{
		...
		try {
			m_Driver.switchTo().defaultContent();
			m_Driver.switchTo().frame(getWebElement(By.xpath("//*[@id=\"ctl00_cPH_tbContainer_TbSoleTrader_btnempAddIframe\"]")));
			...
			JavascriptExecutor jsExecutor = (JavascriptExecutor) m_Driver;  
			//set the text
			jsExecutor.executeScript("document.getElementById('ctl00_cPH_txtAddress2').value='"+ctl00cPHtxtAddress2+"'");  
...
Thread.sleep(5000);
     ...
     * @name Enter ctl00$cPH$txtAddress1
     */
 	public void Enter_ctl00cPHtxtAddress1_1(String ctl00cPHtxtAddress1)
 	{
 	    
		try {
			m_Driver.switchTo().frame(getWebElement(By.xpath("/html/body/div[2]/div[1]/div[2]/div[2]/div[1]/iframe")));

			WebElement elem = getWebElement(ctl00cPHtxtAddress1_1Elem);

			if (elem == null) {
				ExtentReportManager.failStepWithScreenshot(m_Driver, "Enter_ctl00cPHtxtAddress1_1", "Enter_ctl00cPHtxtAddress1_1 failed. Unable to locate object: " + ctl00cPHtxtAddress1_1Elem.toString());

				TestModellerLogger.FailStepWithScreenshot(m_Driver, "Enter_ctl00cPHtxtAddress1_1", "Enter_ctl00cPHtxtAddress1_1 failed. Unable to locate object: " + ctl00cPHtxtAddress1_1Elem.toString());

				Assert.fail("Unable to locate object: " + ctl00cPHtxtAddress1_1Elem.toString());
			 }
elem.clear();
Thread.sleep(5000);
			elem.sendKeys(ctl00cPHtxtAddress1);
		...
		m_Driver.switchTo().defaultContent();
  		...
  		ExtentReportManager.passStep(m_Driver, "Enter_ctl00cPHtxtAddress1_1 " + ctl00cPHtxtAddress1);

  		TestModellerLogger.PassStep(m_Driver, "Enter_ctl00cPHtxtAddress1_1 " + ctl00cPHtxtAddress1);
 	}
     ...
     * @name Enter ctl00$cPH$txtAddress2
     */
 	public void Enter_ctl00cPHtxtAddress2_1(String ctl00cPHtxtAddress2)
 	{
 	    
		try {
			m_Driver.switchTo().frame(getWebElement(By.xpath("/html/body/div[2]/div[1]/div[2]/div[2]/div[1]/iframe")));

			WebElement elem = getWebElement(ctl00cPHtxtAddress2_1Elem);

			if (elem == null) {
				ExtentReportManager.failStepWithScreenshot(m_Driver, "Enter_ctl00cPHtxtAddress2_1", "Enter_ctl00cPHtxtAddress2_1 failed. Unable to locate object: " + ctl00cPHtxtAddress2_1Elem.toString());

				TestModellerLogger.FailStepWithScreenshot(m_Driver, "Enter_ctl00cPHtxtAddress2_1", "Enter_ctl00cPHtxtAddress2_1 failed. Unable to locate object: " + ctl00cPHtxtAddress2_1Elem.toString());

				Assert.fail("Unable to locate object: " + ctl00cPHtxtAddress2_1Elem.toString());
			 }
elem.clear();
Thread.sleep(5000);
			elem.sendKeys(ctl00cPHtxtAddress2);
		...
		m_Driver.switchTo().defaultContent();
  		...
  		ExtentReportManager.passStep(m_Driver, "Enter_ctl00cPHtxtAddress2_1 " + ctl00cPHtxtAddress2);

  		TestModellerLogger.PassStep(m_Driver, "Enter_ctl00cPHtxtAddress2_1 " + ctl00cPHtxtAddress2);
 	}
     ...
     * @name Enter ctl00$cPH$txtAddress3
     */
 	public void Enter_ctl00cPHtxtAddress3_1(String ctl00cPHtxtAddress3)
 	{
 	    
		try {
			m_Driver.switchTo().frame(getWebElement(By.xpath("/html/body/div[2]/div[1]/div[2]/div[2]/div[1]/iframe")));

			WebElement elem = getWebElement(ctl00cPHtxtAddress3_1Elem);

			if (elem == null) {
				ExtentReportManager.failStepWithScreenshot(m_Driver, "Enter_ctl00cPHtxtAddress3_1", "Enter_ctl00cPHtxtAddress3_1 failed. Unable to locate object: " + ctl00cPHtxtAddress3_1Elem.toString());

				TestModellerLogger.FailStepWithScreenshot(m_Driver, "Enter_ctl00cPHtxtAddress3_1", "Enter_ctl00cPHtxtAddress3_1 failed. Unable to locate object: " + ctl00cPHtxtAddress3_1Elem.toString());

				Assert.fail("Unable to locate object: " + ctl00cPHtxtAddress3_1Elem.toString());
			 }
elem.clear();
Thread.sleep(5000);
			elem.sendKeys(ctl00cPHtxtAddress3);
		...
		m_Driver.switchTo().defaultContent();
  		...
  		ExtentReportManager.passStep(m_Driver, "Enter_ctl00cPHtxtAddress3_1 " + ctl00cPHtxtAddress3);

  		TestModellerLogger.PassStep(m_Driver, "Enter_ctl00cPHtxtAddress3_1 " + ctl00cPHtxtAddress3);
 	}
     ...
     * @name Enter ctl00$cPH$txtAddress4
     */
 	public void Enter_ctl00cPHtxtAddress4_1(String ctl00cPHtxtAddress4)
 	{
 	    
		try {
			m_Driver.switchTo().frame(getWebElement(By.xpath("/html/body/div[2]/div[1]/div[2]/div[2]/div[1]/iframe")));

			WebElement elem = getWebElement(ctl00cPHtxtAddress4_1Elem);

			if (elem == null) {
				ExtentReportManager.failStepWithScreenshot(m_Driver, "Enter_ctl00cPHtxtAddress4_1", "Enter_ctl00cPHtxtAddress4_1 failed. Unable to locate object: " + ctl00cPHtxtAddress4_1Elem.toString());

				TestModellerLogger.FailStepWithScreenshot(m_Driver, "Enter_ctl00cPHtxtAddress4_1", "Enter_ctl00cPHtxtAddress4_1 failed. Unable to locate object: " + ctl00cPHtxtAddress4_1Elem.toString());

				Assert.fail("Unable to locate object: " + ctl00cPHtxtAddress4_1Elem.toString());
			 }
elem.clear();
Thread.sleep(5000);
			elem.sendKeys(ctl00cPHtxtAddress4);
		...
		m_Driver.switchTo().defaultContent();
  		...
  		ExtentReportManager.passStep(m_Driver, "Enter_ctl00cPHtxtAddress4_1 " + ctl00cPHtxtAddress4);

  		TestModellerLogger.PassStep(m_Driver, "Enter_ctl00cPHtxtAddress4_1 " + ctl00cPHtxtAddress4);
 	}
...
Thread.sleep(1000);
	...
	public void Click_Partnership_Information()
	{
		...
		Assert.assertEquals(expected, "ABC XYZ");  	
