...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/f31ae11c-ff95-47d8-85ba-1098addf473a
@TestModellerModule(guid = "f31ae11c-ff95-47d8-85ba-1098addf473a")
public class Depreciation_and_other_amounts_written_off_assets2FA775 extends BasePage
{
	public Depreciation_and_other_amounts_written_off_assets2FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(3000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[94]/td[2]")).getText();
						Assert.assertEquals(expected, "7630");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
