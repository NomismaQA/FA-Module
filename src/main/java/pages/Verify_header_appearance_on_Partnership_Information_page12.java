...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/8260c157-a4e4-45cb-beb4-a1949360d8b7
@TestModellerModule(guid = "8260c157-a4e4-45cb-beb4-a1949360d8b7")
public class Verify_header_appearance_on_Partnership_Information_page12 extends BasePage
{
	public Verify_header_appearance_on_Partnership_Information_page12 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _ABC_LLP_Elem = By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_cPH_rptrDisplayRecords_ctl00_rowCompany\"]/td[1]/span");
...
Thread.sleep(5000);
	...
	public void Click_Filleted_Accounts()
	{
		...
		elem.click();
		String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[6]/div/table[1]/tbody/tr/td")).getText();
...
//				"For the year ended 30 April 2022");
		...
		Assert.assertEquals(str[1],"Partnership Information");
		Assert.assertEquals(str[2],"For the year ended 31 December 2021");
