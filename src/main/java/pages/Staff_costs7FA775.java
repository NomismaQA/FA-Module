...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/4acbbbf6-2c52-49c2-a23a-58efc25ff864
@TestModellerModule(guid = "4acbbbf6-2c52-49c2-a23a-58efc25ff864")
public class Staff_costs7FA775 extends BasePage
{
	public Staff_costs7FA775 (WebDriver driver)
	{
		super(driver);
	}
	...
	public void Click_Staff_Costs()
	{
		...
		try {
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[66]/td[2]")).getText();
						Assert.assertEquals(expected, "7266");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
