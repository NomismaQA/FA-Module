...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/9ad89a0d-c342-423f-abda-e801b7bb5ae8
@TestModellerModule(guid = "9ad89a0d-c342-423f-abda-e801b7bb5ae8")
public class Verify_trading_office_address_appearing_on_partnership_Information_page19 extends BasePage
{
	public Verify_trading_office_address_appearing_on_partnership_Information_page19 (WebDriver driver)
	{
		super(driver);
	}
...
elem.clear();
	...
	public void Click_Partnership_Information()
	{
		...
		elem.click();
		String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[6]/div/table[2]/tbody/tr[21]")).getText();
