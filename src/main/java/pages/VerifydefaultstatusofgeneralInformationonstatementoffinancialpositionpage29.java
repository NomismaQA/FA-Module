...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/eb8d090a-720b-406c-bc71-950faf65fcb9
@TestModellerModule(guid = "eb8d090a-720b-406c-bc71-950faf65fcb9")
public class VerifydefaultstatusofgeneralInformationonstatementoffinancialpositionpage29 extends BasePage
{
	public VerifydefaultstatusofgeneralInformationonstatementoffinancialpositionpage29 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By UsrnameElem = By.xpath("//INPUT[@name='ctl00$cPH$login']");
	...
	private By Edit1Elem = By.xpath("//A[@id='ctl00_cPH_rptrDisplayRecords_ctl00_lnkEdit']");
   ...
   public void AssertUrl()
     ...
     * @name Enter Usrname
     */
 	public void Enter_Usrname(String Usrname)
 	{
 	    
 		WebElement elem = getWebElement(UsrnameElem);

 		if (elem == null) {
    		ExtentReportManager.failStepWithScreenshot(m_Driver, "Enter_Usrname", "Enter_Usrname failed. Unable to locate object: " + UsrnameElem.toString());

    		TestModellerLogger.FailStepWithScreenshot(m_Driver, "Enter_Usrname", "Enter_Usrname failed. Unable to locate object: " + UsrnameElem.toString());

 			Assert.fail("Unable to locate object: " + UsrnameElem.toString());
         }

 		elem.sendKeys(Usrname);
 		
 		
  		ExtentReportManager.passStep(m_Driver, "Enter_Usrname " + Usrname);

  		TestModellerLogger.PassStep(m_Driver, "Enter_Usrname " + Usrname);
 	}
...
Assert.assertEquals(expected, "(1) Members: benefits advances, credit and guarantees");
