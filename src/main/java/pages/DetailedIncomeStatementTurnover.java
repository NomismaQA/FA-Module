...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/179824fc-1e02-437d-b5b5-12b294a263c8
@TestModellerModule(guid = "179824fc-1e02-437d-b5b5-12b294a263c8")
public class DetailedIncomeStatementTurnover extends BasePage
{
	public DetailedIncomeStatementTurnover (WebDriver driver)
	{
		super(driver);
	}
	...
	private By Detailed_Income_StatementElem = By.xpath("//A[@style='background-color: red !important;']");

	private By TurnoverElem = By.xpath("//*[@id=\"disDiv\"]/div/div[13]/div/table[2]/tbody/tr[6]");
...
*/
     ...
     * @name Click Turnover
     */
	public void Click_Turnover()
	{
        
		WebElement elem = getWebElement(TurnoverElem);

		if (elem == null) {
    		ExtentReportManager.failStepWithScreenshot(m_Driver, "Click_Turnover", "Click_Turnover failed. Unable to locate object: " + TurnoverElem.toString());

    		TestModellerLogger.FailStepWithScreenshot(m_Driver, "Click_Turnover", "Click_Turnover failed. Unable to locate object: " + TurnoverElem.toString());

			Assert.fail("Unable to locate object: " + TurnoverElem.toString());
        }

		elem.click();
          	

		ExtentReportManager.passStep(m_Driver, "Click_Turnover");

		TestModellerLogger.PassStep(m_Driver, "Click_Turnover");
	}
}