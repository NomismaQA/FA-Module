...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/78a3a136-3570-4957-bbc1-ade0ba1e99d9
@TestModellerModule(guid = "78a3a136-3570-4957-bbc1-ade0ba1e99d9")
public class DetailedIncomeStatementOther_charges36 extends BasePage
{
	public DetailedIncomeStatementOther_charges36 (WebDriver driver)
	{
		super(driver);
	}
