...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/222654b2-c60c-4af8-b91e-03be535aa0db
@TestModellerModule(guid = "222654b2-c60c-4af8-b91e-03be535aa0db")
public class Verify_default_status_of_Guarantees_and_other_financial_commitments59 extends BasePage
{
	public Verify_default_status_of_Guarantees_and_other_financial_commitments59 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(1000);
	...
	public void Click_Full_Accounts()
	{
		...
		elem.click();
		String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[14]/div/table[2]/tbody/tr[19]/td/table/tbody/tr[9]/td")).getText();
