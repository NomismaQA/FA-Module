...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/a21b4ad0-06fe-4470-a8ff-912d71b175e4
@TestModellerModule(guid = "a21b4ad0-06fe-4470-a8ff-912d71b175e4")
public class Other_charges24FA775 extends BasePage
{
	public Other_charges24FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[36]/td[2]")).getText();
						Assert.assertEquals(expected, "7014");
						...
						if(data.contains("7014"))
						{
							String[] dd = data.split("0");
							System.out.println(dd[0]);
							Assert.assertEquals(dd[0], "7014");
						}
						}
		} catch (Exception e) {
			// TODO Auto-generated catch block
