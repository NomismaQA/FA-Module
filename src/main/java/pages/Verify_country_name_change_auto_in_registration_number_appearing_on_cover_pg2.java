...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/f21772a7-3505-4894-81f9-6bc4078dccaa
@TestModellerModule(guid = "f21772a7-3505-4894-81f9-6bc4078dccaa")
public class Verify_country_name_change_auto_in_registration_number_appearing_on_cover_pg2 extends BasePage
{
	public Verify_country_name_change_auto_in_registration_number_appearing_on_cover_pg2 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _Testing_Partners_Elem = By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_cPH_rptrDisplayRecords_ctl00_rowCompany\"]/td[1]/span");
	...
	private By Cover_PageElem = By.xpath("//A[contains(text(),'Cover Page')]");


	
	public void GoToUrl()
	{
		m_Driver.get("http://sandbox4.nomismasolution.co.uk/ssoui/Signin.aspx?token=5594ffe7-53d6-41b5-a044-1126fd27b27c");

		ExtentReportManager.passStepWithScreenshot(m_Driver, "Go to URL", "http://sandbox4.nomismasolution.co.uk/ssoui/Signin.aspx?token=5594ffe7-53d6-41b5-a044-1126fd27b27c");
		
		TestModellerLogger.PassStepWithScreenshot(m_Driver, "Go to URL", "http://sandbox4.nomismasolution.co.uk/ssoui/Signin.aspx?token=5594ffe7-53d6-41b5-a044-1126fd27b27c");
	}
   ...
   public void AssertUrl()
    {
        ...
        String expectedUrl = "http://sandbox4.nomismasolution.co.uk/ssoui/Signin.aspx?token=5594ffe7-53d6-41b5-a044-1126fd27b27c";

        if (!currentUrl.equals("http://sandbox4.nomismasolution.co.uk/ssoui/Signin.aspx?token=5594ffe7-53d6-41b5-a044-1126fd27b27c")) {
...
Thread.sleep(5000);
	...
	/**
 	 * Click  Testing Partners 
     * @name Click  Testing Partners 
     */
	public void Click__Testing_Partners_()
	{
        
		WebElement elem = getWebElement(_Testing_Partners_Elem);

		if (elem == null) {
    		ExtentReportManager.failStepWithScreenshot(m_Driver, "Click__Testing_Partners_", "Click__Testing_Partners_ failed. Unable to locate object: " + _Testing_Partners_Elem.toString());

    		TestModellerLogger.FailStepWithScreenshot(m_Driver, "Click__Testing_Partners_", "Click__Testing_Partners_ failed. Unable to locate object: " + _Testing_Partners_Elem.toString());

			Assert.fail("Unable to locate object: " + _Testing_Partners_Elem.toString());
        }

		elem.click();
        ChangeWindow.tabswitch(m_Driver);  	

		ExtentReportManager.passStep(m_Driver, "Click__Testing_Partners_");

		TestModellerLogger.PassStep(m_Driver, "Click__Testing_Partners_");
	}
