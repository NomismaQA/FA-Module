...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/20eae879-2edf-4623-9cbb-6cb40c6a276a
@TestModellerModule(guid = "20eae879-2edf-4623-9cbb-6cb40c6a276a")
public class Other_charges25FA775 extends BasePage
{
	public Other_charges25FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[37]/td[2]")).getText();
						Assert.assertEquals(expected, "7015");
						...
						if(data.contains("7015"))
						{
							String[] dd = data.split("0");
							System.out.println(dd[0]);
							Assert.assertEquals(dd[0], "7015");
						}
						}
		} catch (Exception e) {
			// TODO Auto-generated catch block
