...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/40e5cf4f-63eb-4b78-bb89-0cd4cdb37927
@TestModellerModule(guid = "40e5cf4f-63eb-4b78-bb89-0cd4cdb37927")
public class Verify_header_appearance_on_content_pageFA6944 extends BasePage
{
	public Verify_header_appearance_on_content_pageFA6944 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _Final_Accounts__1Elem = By.xpath("//*[@id=\"ctl00_SideMenu1_liFinalAccounts\"]/a/span");
...
Thread.sleep(10000);
     ...
     */
	public void Click__Final_Accounts__1()
	{
	...
	public void Click__Final_Accounts_()
	{
		...
		WebElement elem = getWebElement(_Final_Accounts__1Elem);

		if (elem == null) {
    		ExtentReportManager.failStepWithScreenshot(m_Driver, "Click__Final_Accounts__1", "Click__Final_Accounts__1 failed. Unable to locate object: " + _Final_Accounts__1Elem.toString());

    		TestModellerLogger.FailStepWithScreenshot(m_Driver, "Click__Final_Accounts__1", "Click__Final_Accounts__1 failed. Unable to locate object: " + _Final_Accounts__1Elem.toString());

			Assert.fail("Unable to locate object: " + _Final_Accounts__1Elem.toString());
        }

		elem.click();
          	

		ExtentReportManager.passStep(m_Driver, "Click__Final_Accounts__1");

		TestModellerLogger.PassStep(m_Driver, "Click__Final_Accounts__1");
	}
	...
	public void Click_Full_Accounts()
	{
		...
		elem.click();
		String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[4]/div/table[1]/tbody/tr/td")).getText();
//		Assert.assertEquals(expected, "Registered No. OC121212 (England and Wales)");

String[] str = expected.split("\\n");
		Assert.assertEquals(str[0],"ABC LTD");
		Assert.assertEquals(str[1],"Contents");
		Assert.assertEquals(str[2],"For the year ended 4 April 2022");  	
