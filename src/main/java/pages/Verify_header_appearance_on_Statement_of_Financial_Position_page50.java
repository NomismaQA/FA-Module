...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/ae7d04fc-fd09-4b79-b92d-a5b52e842cf2
@TestModellerModule(guid = "ae7d04fc-fd09-4b79-b92d-a5b52e842cf2")
public class Verify_header_appearance_on_Statement_of_Financial_Position_page50 extends BasePage
{
	public Verify_header_appearance_on_Statement_of_Financial_Position_page50 (WebDriver driver)
	{
		super(driver);
	}
...
elem.click();
		String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[16]/div/table[1]/tbody/tr/td/span[1]")).getText();
