...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/bd03e8fe-0e4e-448e-9a76-68b8cbc95f13
@TestModellerModule(guid = "bd03e8fe-0e4e-448e-9a76-68b8cbc95f13")
public class Staff_costs5FA775 extends BasePage
{
	public Staff_costs5FA775 (WebDriver driver)
	{
		super(driver);
	}
	...
	public void Click_Staff_Costs()
	{
		...
		try {
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[63]/td[2]")).getText();
						Assert.assertEquals(expected, "7262");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
