...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/959d279d-1613-4577-a193-c1f4741ec939
@TestModellerModule(guid = "959d279d-1613-4577-a193-c1f4741ec939")
public class Other_charges26FA775 extends BasePage
{
	public Other_charges26FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[41]/td[2]")).getText();
						Assert.assertEquals(expected, "7022");
						...
						if(data.contains("7022"))
						{
							String[] dd = data.split("0");
							System.out.println(dd[0]);
							Assert.assertEquals(dd[0], "7022");
						}
						}
		} catch (Exception e) {
			// TODO Auto-generated catch block
