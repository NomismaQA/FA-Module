...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/41a82583-3aa8-475a-ab59-c77f488b6ab6
@TestModellerModule(guid = "41a82583-3aa8-475a-ab59-c77f488b6ab6")
public class Depreciation_and_other_amounts_written_off_assetsFA775 extends BasePage
{
	public Depreciation_and_other_amounts_written_off_assetsFA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			elem.click();
		Thread.sleep(3000);
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"disDiv\"]/div/div[9]/div/table[2]/tbody/tr[19]/td[5]/a/ix:nonfraction")).getText();
			Assert.assertEquals(expected, "2,212");
...
//	public void Click_Staff_Costs()
//	{
//
//		try {
//			WebElement elem = getWebElement(Staff_CostsElem);
//
//			if (elem == null) {
//				ExtentReportManager.failStepWithScreenshot(m_Driver, "Click__5533_", "Click__5533_ failed. Unable to locate object: " + Staff_CostsElem.toString());
//
//				TestModellerLogger.FailStepWithScreenshot(m_Driver, "Click__5533_", "Click__5533_ failed. Unable to locate object: " + Staff_CostsElem.toString());
//
//				Assert.fail("Unable to locate object: " + Staff_CostsElem.toString());
//			}
//			Thread.sleep(5000);
...
//						elem.click();
//						Thread.sleep(5000);
//						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[62]/td[2]")).getText();
//						Assert.assertEquals(expected, "7260");
//		} catch (Exception e) {
//			// TODO Auto-generated catch block
//			e.printStackTrace();
//		}
