...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/eb259c80-718e-4612-b008-60f8e5a6255d
@TestModellerModule(guid = "eb259c80-718e-4612-b008-60f8e5a6255d")
public class Cost_of_raw_materials_and_consumablesFA775 extends BasePage
{
	public Cost_of_raw_materials_and_consumablesFA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			elem.click();
			Thread.sleep(5000);
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"disDiv\"]/div/div[9]/div/table[2]/tbody/tr[8]/td[5]/a")).getText();
			Assert.assertEquals(expected, "(5,038)");
