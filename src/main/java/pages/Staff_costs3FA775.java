...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/d4076368-37fd-491a-be69-594a2a05f9a4
@TestModellerModule(guid = "d4076368-37fd-491a-be69-594a2a05f9a4")
public class Staff_costs3FA775 extends BasePage
{
	public Staff_costs3FA775 (WebDriver driver)
	{
		super(driver);
	}
 	...
 	public void Click_Staff_Costs()
 	{
 		...
 		try {
 			...
 			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
 						elem.click();
 						Thread.sleep(5000);
 						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[58]/td[2]")).getText();
 						Assert.assertEquals(expected, "7251");
 		} catch (Exception e) {
 			// TODO Auto-generated catch block
 			e.printStackTrace();
 		}
