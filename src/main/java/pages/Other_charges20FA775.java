...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/4d573a53-e740-4959-8167-c1051e1a3397
@TestModellerModule(guid = "4d573a53-e740-4959-8167-c1051e1a3397")
public class Other_charges20FA775 extends BasePage
{
	public Other_charges20FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[56]/td[2]")).getText();
						Assert.assertEquals(expected, "7213");
						...
						if(data.contains("7213"))
						{
							String[] dd = data.split("0");
							System.out.println(dd[0]);
							Assert.assertEquals(dd[0], "7213");
						}
						}
		} catch (Exception e) {
			// TODO Auto-generated catch block
