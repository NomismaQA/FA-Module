...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/c0d4ec62-75d0-417b-be97-904fddee4ea5
@TestModellerModule(guid = "c0d4ec62-75d0-417b-be97-904fddee4ea5")
public class Cost_of_raw_materials_and_consumables4FA775 extends BasePage
{
	public Cost_of_raw_materials_and_consumables4FA775 (WebDriver driver)
	{
		super(driver);
	}
...
action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
			elem.click();
			Thread.sleep(5000);
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[17]/td[2]")).getText();
			Assert.assertEquals(expected, "5000");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} 	
