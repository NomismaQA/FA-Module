...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/fdfa1ed9-dddf-4db3-bd42-4fed888fd1e8
@TestModellerModule(guid = "fdfa1ed9-dddf-4db3-bd42-4fed888fd1e8")
public class Verify_header_appearance_on_accountants_report_pageFA69642 extends BasePage
{
	public Verify_header_appearance_on_accountants_report_pageFA69642 (WebDriver driver)
	{
		super(driver);
	}
