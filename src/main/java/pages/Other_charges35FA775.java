...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/ba52c189-20cc-459d-b1b8-48e74e9d87fd
@TestModellerModule(guid = "ba52c189-20cc-459d-b1b8-48e74e9d87fd")
public class Other_charges35FA775 extends BasePage
{
	public Other_charges35FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[46]/td[2]")).getText();
						Assert.assertEquals(expected, "7035");
						...
						if(data.contains("7035"))
						{
							String[] dd = data.split("0");
							System.out.println(dd[0]);
							Assert.assertEquals(dd[0], "7035");
						}
						}
		} catch (Exception e) {
			// TODO Auto-generated catch block
