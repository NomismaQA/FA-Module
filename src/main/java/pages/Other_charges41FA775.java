...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/78a169e9-4d18-4bf6-9a09-0f0c72e92705
@TestModellerModule(guid = "78a169e9-4d18-4bf6-9a09-0f0c72e92705")
public class Other_charges41FA775 extends BasePage
{
	public Other_charges41FA775 (WebDriver driver)
	{
		super(driver);
	}
...
//*/
	public void Click_Other_charges() {
		...
		try {
			...
			elem.click();
			Thread.sleep(5000);
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_rptrExpenseByDateRange_ctl48_lnkView\"]/span[1]")).getText();
			Assert.assertEquals(expected, "7402");
