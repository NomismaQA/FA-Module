...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/028cfad1-3298-4381-a6f1-0b753c8b045c
@TestModellerModule(guid = "028cfad1-3298-4381-a6f1-0b753c8b045c")
public class Depreciation_and_other_amounts_written_off_assets1FA775 extends BasePage
{
	public Depreciation_and_other_amounts_written_off_assets1FA775 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By Depreciation_and_other_amounts_written_off_assetsElem = By.xpath("//A[@href='Popup/FAViewTrialBalance.aspx?StandardCode=2&MainSection=PL&Year=P&Section=DEP&FYCode=53174&CompanyCode=13249']");
...
//			String expected = m_Driver.findElement(By.xpath("//*[@id=\"disDiv\"]/div/div[9]/div/table[2]/tbody/tr[12]/td[5]/a/ix:nonfraction")).getText();
//			Assert.assertEquals(expected, "3,071");
	...
	/**
 	 * Click Depreciation and other amounts written off assets
     * @name Click Depreciation and other amounts written off assets
     */
	public void Click_Depreciation_and_other_amounts_written_off_assets()
	{
        
		try {
			WebElement elem = getWebElement(Depreciation_and_other_amounts_written_off_assetsElem);

			if (elem == null) {
				ExtentReportManager.failStepWithScreenshot(m_Driver, "Click_Depreciation_and_other_amounts_written_off_assets", "Click_Depreciation_and_other_amounts_written_off_assets failed. Unable to locate object: " + Depreciation_and_other_amounts_written_off_assetsElem.toString());

				TestModellerLogger.FailStepWithScreenshot(m_Driver, "Click_Depreciation_and_other_amounts_written_off_assets", "Click_Depreciation_and_other_amounts_written_off_assets failed. Unable to locate object: " + Depreciation_and_other_amounts_written_off_assetsElem.toString());

				Assert.fail("Unable to locate object: " + Depreciation_and_other_amounts_written_off_assetsElem.toString());
			}
Thread.sleep(3000);
			elem.click();
			Thread.sleep(5000);
			Actions action= new Actions(m_Driver);
 			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
 						elem.click();
 						Thread.sleep(5000);
 						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[88]/td[2]")).getText();
 						Assert.assertEquals(expected, "7603");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		...
		ExtentReportManager.passStep(m_Driver, "Click_Depreciation_and_other_amounts_written_off_assets");

		TestModellerLogger.PassStep(m_Driver, "Click_Depreciation_and_other_amounts_written_off_assets");
	}
}