...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/6f80846c-920b-4cab-98b2-dc9ee5e43aeb
@TestModellerModule(guid = "6f80846c-920b-4cab-98b2-dc9ee5e43aeb")
public class CostofSales8FA775 extends BasePage
{
	public CostofSales8FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(7000);
			elem.click();
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_divScroll\"]/div/table/tbody[2]/tr[7]")).getText();
			Assert.assertEquals(expected, "5000	Opening stock	242.00");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
