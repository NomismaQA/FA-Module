...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/5706f04c-9ba4-4093-a11a-64bd537ed26f
@TestModellerModule(guid = "5706f04c-9ba4-4093-a11a-64bd537ed26f")
public class Cost_of_raw_materials_and_consumables6FA775 extends BasePage
{
	public Cost_of_raw_materials_and_consumables6FA775 (WebDriver driver)
	{
		super(driver);
	}
...
action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
			elem.click();
			Thread.sleep(5000);
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[24]/td[2]")).getText();
			Assert.assertEquals(expected, "6060");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} 	
