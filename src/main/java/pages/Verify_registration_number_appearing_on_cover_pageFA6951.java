...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/1f545d7a-a41f-4f0b-a87e-f78d94816267
@TestModellerModule(guid = "1f545d7a-a41f-4f0b-a87e-f78d94816267")
public class Verify_registration_number_appearing_on_cover_pageFA6951 extends BasePage
{
	public Verify_registration_number_appearing_on_cover_pageFA6951 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By Edit1Elem = By.xpath("//*[@id=\"ctl00_cpHeaderRight_btnEdit\"]");

	private By Address1Elem = By.xpath("//label[contains(.,'Registration Address *')]/../../div[2]/input");
	...
	private By PostCodeElem = By.xpath("//label[contains(.,'Registration Postcode *')]/../../div[2]/input");

	private By RegNoElem = By.xpath("//label[contains(.,'Registration Number *')]/../../div[2]/input");
