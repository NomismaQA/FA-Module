...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/b2d356a4-8a84-4782-b4c0-18099f07f214
@TestModellerModule(guid = "b2d356a4-8a84-4782-b4c0-18099f07f214")
public class Verify_registered_office_address_appearing_on_partnership_information_page18 extends BasePage
{
	public Verify_registered_office_address_appearing_on_partnership_information_page18 (WebDriver driver)
	{
		super(driver);
	}
...
elem.clear();
	...
	public void Click_Partnership_Information()
	{
		...
		elem.click();
		String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[6]/div/table[2]/tbody/tr[15]")).getText();
