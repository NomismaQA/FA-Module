...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/67cea29f-2384-4149-aebd-5712a880c67c
@TestModellerModule(guid = "67cea29f-2384-4149-aebd-5712a880c67c")
public class DetailedIncomeStatementOther_charges30 extends BasePage
{
	public DetailedIncomeStatementOther_charges30 (WebDriver driver)
	{
		super(driver);
	}
