...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/1a7d1970-4abd-4054-b459-96cf1c4d261c
@TestModellerModule(guid = "1a7d1970-4abd-4054-b459-96cf1c4d261c")
public class Other_charges29FA775 extends BasePage
{
	public Other_charges29FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[77]/td[2]")).getText();
						Assert.assertEquals(expected, "7401");
						...
						if(data.contains("7401"))
						{
							String[] dd = data.split("0");
							System.out.println(dd[0]);
							Assert.assertEquals(dd[0], "7401");
						}
						}
		} catch (Exception e) {
			// TODO Auto-generated catch block
