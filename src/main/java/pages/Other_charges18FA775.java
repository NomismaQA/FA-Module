...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/762f765f-5631-44f7-adef-e989e2ee01d5
@TestModellerModule(guid = "762f765f-5631-44f7-adef-e989e2ee01d5")
public class Other_charges18FA775 extends BasePage
{
	public Other_charges18FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[44]/td[2]")).getText();
						Assert.assertEquals(expected, "7032");
						...
						if(data.contains("7032"))
						{
							String[] dd = data.split("0");
							System.out.println(dd[0]);
							Assert.assertEquals(dd[0], "7032");
						}
						}
		} catch (Exception e) {
			// TODO Auto-generated catch block
