...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/96f1c272-422f-45cf-b095-35fa501f4af4
@TestModellerModule(guid = "96f1c272-422f-45cf-b095-35fa501f4af4")
public class Verify_header_appearance_on_Income_statement_pageFA69648 extends BasePage
{
	public Verify_header_appearance_on_Income_statement_pageFA69648 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(10000);
	...
	public void Click_Full_Accounts()
	{
		...
		elem.click();
		String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[14]/div/table[1]/tbody/tr/td/span[1]")).getText();
