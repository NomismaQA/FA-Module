...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/8fcce06b-af6d-4e7c-8aba-b79180ec7a8e
@TestModellerModule(guid = "8fcce06b-af6d-4e7c-8aba-b79180ec7a8e")
public class Cost_of_raw_materials_and_consumables1FA775 extends BasePage
{
	public Cost_of_raw_materials_and_consumables1FA775 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _Clients_Elem = By.xpath("//*[@id='ctl00_ctl00_ParentContent_SideMenu1_businessMenu']/a");
	...
	private By Final_Accounts1Elem = By.xpath("//*[@id='ctl00_SideMenu1_FA']/a");
	
	private By Final_Accounts2Elem = By.xpath("//*[@id='ctl00_SideMenu1_liFinalAccounts']/a/span");

	private By Full_AccountsElem = By.xpath("//*[@id='ctl00_SideMenu1_FAFullAccNameAccounts']");
...
Thread.sleep(5000);
			...
			Assert.assertEquals(expected, "5200	Closing stock	-246.00");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} 	
