...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/2d46f4e3-9beb-44ba-8e46-e24c20b38646
@TestModellerModule(guid = "2d46f4e3-9beb-44ba-8e46-e24c20b38646")
public class Other_charges10FA775 extends BasePage
{
	public Other_charges10FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[83]/td[2]")).getText();
						Assert.assertEquals(expected, "7209");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
