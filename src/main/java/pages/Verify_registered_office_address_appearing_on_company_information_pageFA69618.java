...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/7fe1c359-858f-4848-a410-5b2a7ed28da5
@TestModellerModule(guid = "7fe1c359-858f-4848-a410-5b2a7ed28da5")
public class Verify_registered_office_address_appearing_on_company_information_pageFA69618 extends BasePage
{
	public Verify_registered_office_address_appearing_on_company_information_pageFA69618 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(3000);
	...
	public void Click_Full_Accounts()
	{
		...
		elem.click();
		String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[6]/div/table[2]/tbody/tr[40]")).getText();
