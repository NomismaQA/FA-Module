...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/abf67db3-ef1d-411d-b16d-188610f0fd8f
@TestModellerModule(guid = "abf67db3-ef1d-411d-b16d-188610f0fd8f")
public class Verify_if_user_remove_notes_in_Notes_to_the_Accounts_and_bring_it_down_it_into_one_pageFA69413 extends BasePage
{
	public Verify_if_user_remove_notes_in_Notes_to_the_Accounts_and_bring_it_down_it_into_one_pageFA69413 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By Final_Accounts2Elem = By.xpath("//LI[@id='ctl00_SideMenu1_FA']/A");
	...
	private By Edit1Elem = By.xpath("//*[@id=\"ctl00_cPH_rptrDisplayRecords_ctl03_lnkEdit\"]");

	private By StatusElem = By.xpath("//label[contains(.,'Status')]/../div/select");

	private By Save_ButtonElem = By.xpath("//A[@id='ctl00_cPH_btnSave']");

	private By Final_Accounts2_1Elem = By.xpath("//LI[@id='ctl00_SideMenu1_liFinalAccounts']/A");
...
Thread.sleep(10000);
     ...
     * @name Click Final Accounts2
     */
	public void Click_Final_Accounts2_1()
	{
        
		WebElement elem = getWebElement(Final_Accounts2_1Elem);

		if (elem == null) {
    		ExtentReportManager.failStepWithScreenshot(m_Driver, "Click_Final_Accounts2_1", "Click_Final_Accounts2_1 failed. Unable to locate object: " + Final_Accounts2_1Elem.toString());

    		TestModellerLogger.FailStepWithScreenshot(m_Driver, "Click_Final_Accounts2_1", "Click_Final_Accounts2_1 failed. Unable to locate object: " + Final_Accounts2_1Elem.toString());

			Assert.fail("Unable to locate object: " + Final_Accounts2_1Elem.toString());
        }

		elem.click();
          	

		ExtentReportManager.passStep(m_Driver, "Click_Final_Accounts2_1");

		TestModellerLogger.PassStep(m_Driver, "Click_Final_Accounts2_1");
	}
