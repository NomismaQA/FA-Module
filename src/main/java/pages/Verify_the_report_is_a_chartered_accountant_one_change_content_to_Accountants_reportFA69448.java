...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/b20ee92e-c884-4d9e-bf92-1b19a2b09ac8
@TestModellerModule(guid = "b20ee92e-c884-4d9e-bf92-1b19a2b09ac8")
public class Verify_the_report_is_a_chartered_accountant_one_change_content_to_Accountants_reportFA69448 extends BasePage
{
	public Verify_the_report_is_a_chartered_accountant_one_change_content_to_Accountants_reportFA69448 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By PageBreakAfterPageNumbersFrs102ShortElem = By.xpath("//SELECT[@name='ctl00$cPH$lstIntroducePageBreakAfterPageNumbersFrs102Short']");

	private By ctl00cPHchkDirectorsYearElem = By.xpath("//label[contains(.,'Include directors who served during the year ?')]/../div/input");
...
Thread.sleep(10000);
	...
	/**
 	 * Select PageBreakAfterPageNumbersFrs102Short
     * @name Select PageBreakAfterPageNumbersFrs102Short
     */
    public void Select_PageBreakAfterPageNumbersFrs102Short(String PageBreakAfterPageNumbersFrs102Short)
 	{
 	    
		m_Driver.switchTo().frame(getWebElement(By.xpath("/html/body/div[2]/div[1]/div[2]/div[2]/div[1]/iframe")));

 		WebElement elem = getWebElement(PageBreakAfterPageNumbersFrs102ShortElem);

 		if (elem == null) {
    		ExtentReportManager.failStepWithScreenshot(m_Driver, "Select_PageBreakAfterPageNumbersFrs102Short", "Select_PageBreakAfterPageNumbersFrs102Short failed. Unable to locate object: " + PageBreakAfterPageNumbersFrs102ShortElem.toString());

    		TestModellerLogger.FailStepWithScreenshot(m_Driver, "Select_PageBreakAfterPageNumbersFrs102Short", "Select_PageBreakAfterPageNumbersFrs102Short failed. Unable to locate object: " + PageBreakAfterPageNumbersFrs102ShortElem.toString());

 			Assert.fail("Unable to locate object: " + PageBreakAfterPageNumbersFrs102ShortElem.toString());
         }

 		Select dropdown = new Select(elem);

 		dropdown.selectByVisibleText(PageBreakAfterPageNumbersFrs102Short);
 		
		m_Driver.switchTo().defaultContent();

 		
 		ExtentReportManager.passStep(m_Driver, "Select_PageBreakAfterPageNumbersFrs102Short " + PageBreakAfterPageNumbersFrs102Short);

 		TestModellerLogger.PassStep(m_Driver, "Select_PageBreakAfterPageNumbersFrs102Short " + PageBreakAfterPageNumbersFrs102Short);
 	}
