...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/8b35a934-e8bf-4f51-9a04-2cc7865201bb
@TestModellerModule(guid = "8b35a934-e8bf-4f51-9a04-2cc7865201bb")
public class TurnoverFA775 extends BasePage
{
	public TurnoverFA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(3000);
			elem.click();
			Thread.sleep(5000);
//			String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_divScroll\"]/div/table/tbody[2]/tr[1]/td[3]")).getText();
//			Assert.assertEquals(expected, "4020	Flat rate saving				(£43,234.00)");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
