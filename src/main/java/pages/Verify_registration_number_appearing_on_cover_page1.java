...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/ee723143-fa3f-46ec-9e96-e82aab92d044
@TestModellerModule(guid = "ee723143-fa3f-46ec-9e96-e82aab92d044")
public class Verify_registration_number_appearing_on_cover_page1 extends BasePage
{
	public Verify_registration_number_appearing_on_cover_page1 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By Save_Button1Elem = By.xpath("//A[@id='ctl00_cPH_tbContainer_TbGeneral_btnGSave']");
