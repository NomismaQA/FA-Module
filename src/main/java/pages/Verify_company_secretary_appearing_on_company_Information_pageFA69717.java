...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/0dd65bdc-c5e8-437b-9fac-af8533d4c5df
@TestModellerModule(guid = "0dd65bdc-c5e8-437b-9fac-af8533d4c5df")
public class Verify_company_secretary_appearing_on_company_Information_pageFA69717 extends BasePage
{
	public Verify_company_secretary_appearing_on_company_Information_pageFA69717 (WebDriver driver)
	{
		super(driver);
	}
...
elem.clear();
	...
	public void Click_Filleted_Accounts()
	{
		...
		elem.click();
		String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[6]/div/table[2]/tbody/tr[47]/td[3]")).getText();
		Assert.assertEquals(expected, "Name1");  	
