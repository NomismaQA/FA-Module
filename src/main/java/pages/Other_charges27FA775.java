...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/cd1db42e-ff4c-46ca-9809-222ffe1590a9
@TestModellerModule(guid = "cd1db42e-ff4c-46ca-9809-222ffe1590a9")
public class Other_charges27FA775 extends BasePage
{
	public Other_charges27FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[84]/td[2]")).getText();
						Assert.assertEquals(expected, "7512");
						...
						if(data.contains("7512"))
						{
							String[] dd = data.split("0");
							System.out.println(dd[0]);
							Assert.assertEquals(dd[0], "7512");
						}
						}
		} catch (Exception e) {
			// TODO Auto-generated catch block
