...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/df94552a-3f8c-45e4-809c-f4d83e59b351
@TestModellerModule(guid = "df94552a-3f8c-45e4-809c-f4d83e59b351")
public class Verify_header_appearance_on_Detailed_Income_Statement68 extends BasePage
{
	public Verify_header_appearance_on_Detailed_Income_Statement68 (WebDriver driver)
	{
		super(driver);
	}
...
//		String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[16]/div/table[1]")).getText();
