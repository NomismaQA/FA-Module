...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/d866c1b2-ecad-4990-98df-68a6a61ce710
@TestModellerModule(guid = "d866c1b2-ecad-4990-98df-68a6a61ce710")
public class Verify_default_status_of_Members_interest64 extends BasePage
{
	public Verify_default_status_of_Members_interest64 (WebDriver driver)
	{
		super(driver);
	}
