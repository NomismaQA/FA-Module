...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/1c8a9f01-4415-4596-9c59-f55e8193fed2
@TestModellerModule(guid = "1c8a9f01-4415-4596-9c59-f55e8193fed2")
public class Verify_default_status_of_General_Information56 extends BasePage
{
	public Verify_default_status_of_General_Information56 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(1000);
	...
	public void Click_Full_Accounts()
	{
		...
		Assert.assertEquals(expected, "(2) Guarantees and other financial commitments");  	
