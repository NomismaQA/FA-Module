...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/06b58cb6-44b9-4a0d-8166-84e62c2c408e
@TestModellerModule(guid = "06b58cb6-44b9-4a0d-8166-84e62c2c408e")
public class Staff_costs9FA775 extends BasePage
{
	public Staff_costs9FA775 (WebDriver driver)
	{
		super(driver);
	}
	...
	public void Click_Staff_Costs()
	{
		...
		try {
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[61]/td[2]")).getText();
						Assert.assertEquals(expected, "7258");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
