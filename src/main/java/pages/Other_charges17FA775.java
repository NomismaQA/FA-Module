...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/f38d50a4-d951-4034-9a6d-51ee986cda36
@TestModellerModule(guid = "f38d50a4-d951-4034-9a6d-51ee986cda36")
public class Other_charges17FA775 extends BasePage
{
	public Other_charges17FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[45]/td[2]")).getText();
						Assert.assertEquals(expected, "7033");
						...
						if(data.contains("7033"))
						{
							String[] dd = data.split("0");
							System.out.println(dd[0]);
							Assert.assertEquals(dd[0], "7033");
						}
						}
		} catch (Exception e) {
			// TODO Auto-generated catch block
