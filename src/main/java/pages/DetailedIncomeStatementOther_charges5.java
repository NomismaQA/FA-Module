...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/ef82a146-040b-478c-b92a-ae6b11ac22a1
@TestModellerModule(guid = "ef82a146-040b-478c-b92a-ae6b11ac22a1")
public class DetailedIncomeStatementOther_charges5 extends BasePage
{
	public DetailedIncomeStatementOther_charges5 (WebDriver driver)
	{
		super(driver);
	}
