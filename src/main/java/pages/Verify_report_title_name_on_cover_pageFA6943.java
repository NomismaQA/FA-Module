...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/86f9d9df-033a-4fd1-b080-6cbd9ac7584a
@TestModellerModule(guid = "86f9d9df-033a-4fd1-b080-6cbd9ac7584a")
public class Verify_report_title_name_on_cover_pageFA6943 extends BasePage
{
	public Verify_report_title_name_on_cover_pageFA6943 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By CompanyNameElem = By.xpath("//*[@id=\"ctl00_cPH_tbContainer_TbGeneral_txtCompanyName\"]");

	private By Address1Elem = By.xpath("//*[@id=\"ctl00_cPH_tbContainer_TbGeneral_txtAddress1\"]");

	private By Address2Elem = By.xpath("//*[@id=\"ctl00_cPH_tbContainer_TbGeneral_txtAddress2\"]");

	private By Address3Elem = By.xpath("//*[@id=\"ctl00_cPH_tbContainer_TbGeneral_txtAddress3\"]");

	private By Address4Elem = By.xpath("//*[@id=\"ctl00_cPH_tbContainer_TbGeneral_txtAddress4\"]");

	private By PostCodeElem = By.xpath("//*[@id=\"ctl00_cPH_tbContainer_TbGeneral_txtPostCode\"]");

	private By RegNoElem = By.xpath("//*[@id=\"ctl00_cPH_tbContainer_TbGeneral_txtRegNo\"]");
