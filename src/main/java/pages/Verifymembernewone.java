...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/e973a091-02b4-4bc5-bdd8-101edd183f87
@TestModellerModule(guid = "e973a091-02b4-4bc5-bdd8-101edd183f87")
public class Verifymembernewone extends BasePage
{
	public Verifymembernewone (WebDriver driver)
	{
		super(driver);
	}
	...
	private By Memberaddress1Elem = By.xpath("//*[@class='col-sm-7 col-xs-7']/input[@name='ctl00$cPH$txtAddress1']");

	private By Memberaddress2Elem = By.xpath("//INPUT[@name='ctl00$cPH$txtAddress2']");

	private By Memberaddress3Elem = By.xpath("//INPUT[@name='ctl00$cPH$txtAddress3']");

	private By Memberaddress4Elem = By.xpath("//INPUT[@name='ctl00$cPH$txtAddress4']");
...
Thread.sleep(1000);
	...
	/**
 	 * Enter Memberaddress1
     * @name Enter Memberaddress1
     */
 	public void Enter_Memberaddress1(String Memberaddress1)
 	{
 		try {
			m_Driver.switchTo().defaultContent();
			m_Driver.switchTo().frame(getWebElement(By.xpath("/html/body/form/main/div[11]/div[3]/div/div[6]/div/div/div/div[2]/div[3]/div/div/div[1]/div[2]/div/div/div/div[2]/iframe")));

			WebElement elem = getWebElement(Memberaddress1Elem);

			if (elem == null) {
				ExtentReportManager.failStepWithScreenshot(m_Driver, "Enter_Memberaddress1", "Enter_Memberaddress1 failed. Unable to locate object: " + Memberaddress1Elem.toString());

				TestModellerLogger.FailStepWithScreenshot(m_Driver, "Enter_Memberaddress1", "Enter_Memberaddress1 failed. Unable to locate object: " + Memberaddress1Elem.toString());

				Assert.fail("Unable to locate object: " + Memberaddress1Elem.toString());
			 }
			Thread.sleep(5000);
			elem.sendKeys(Memberaddress1);
			JavascriptExecutor jsExecutor = (JavascriptExecutor) m_Driver;  
			//set the text
			jsExecutor.executeScript("document.getElementById('ctl00_cPH_txtAddress1').value='"+Memberaddress1+"'");  
			Thread.sleep(5000);
		...
		m_Driver.switchTo().defaultContent();
  		...
  		ExtentReportManager.passStep(m_Driver, "Enter_Memberaddress1 " + Memberaddress1);

  		TestModellerLogger.PassStep(m_Driver, "Enter_Memberaddress1 " + Memberaddress1);
 	}

      
	/**
 	 * Enter Memberaddress2
     * @name Enter Memberaddress2
     */
 	public void Enter_Memberaddress2(String Memberaddress2)
 	{
 		try {
			m_Driver.switchTo().defaultContent(); 
			m_Driver.switchTo().frame(getWebElement(By.xpath("/html/body/form/main/div[11]/div[3]/div/div[6]/div/div/div/div[2]/div[3]/div/div/div[1]/div[2]/div/div/div/div[2]/iframe")));

			WebElement elem = getWebElement(Memberaddress2Elem);

			if (elem == null) {
				ExtentReportManager.failStepWithScreenshot(m_Driver, "Enter_Memberaddress2", "Enter_Memberaddress2 failed. Unable to locate object: " + Memberaddress2Elem.toString());

				TestModellerLogger.FailStepWithScreenshot(m_Driver, "Enter_Memberaddress2", "Enter_Memberaddress2 failed. Unable to locate object: " + Memberaddress2Elem.toString());

				Assert.fail("Unable to locate object: " + Memberaddress2Elem.toString());
			 }
Thread.sleep(5000);
elem.click();
			elem.sendKeys(Memberaddress2);
			JavascriptExecutor jsExecutor = (JavascriptExecutor) m_Driver;  
			//set the text
			jsExecutor.executeScript("document.getElementById('ctl00_cPH_txtAddress2').value='"+Memberaddress2+"'");  
			Thread.sleep(5000);
			JavascriptExecutor je = (JavascriptExecutor)m_Driver;
			je.executeScript("arguments[0].scrollIntoView(true);",elem);
		...
		m_Driver.switchTo().defaultContent();
  		...
  		ExtentReportManager.passStep(m_Driver, "Enter_Memberaddress2 " + Memberaddress2);

  		TestModellerLogger.PassStep(m_Driver, "Enter_Memberaddress2 " + Memberaddress2);
 	}

      
	/**
 	 * Enter Memberaddress3
     * @name Enter Memberaddress3
     */
 	public void Enter_Memberaddress3(String Memberaddress3)
 	{
 		try {
			m_Driver.switchTo().defaultContent(); 
			m_Driver.switchTo().frame(getWebElement(By.xpath("/html/body/form/main/div[11]/div[3]/div/div[6]/div/div/div/div[2]/div[3]/div/div/div[1]/div[2]/div/div/div/div[2]/iframe")));

			WebElement elem = getWebElement(Memberaddress3Elem);

			if (elem == null) {
				ExtentReportManager.failStepWithScreenshot(m_Driver, "Enter_Memberaddress3", "Enter_Memberaddress3 failed. Unable to locate object: " + Memberaddress3Elem.toString());

				TestModellerLogger.FailStepWithScreenshot(m_Driver, "Enter_Memberaddress3", "Enter_Memberaddress3 failed. Unable to locate object: " + Memberaddress3Elem.toString());

				Assert.fail("Unable to locate object: " + Memberaddress3Elem.toString());
			 }
Thread.sleep(5000);
			elem.sendKeys(Memberaddress3);
			Thread.sleep(5000);
			JavascriptExecutor je = (JavascriptExecutor)m_Driver;
			je.executeScript("arguments[0].scrollIntoView(true);",elem);
		} catch (Exception e) {
		...
		m_Driver.switchTo().defaultContent();
  		...
  		ExtentReportManager.passStep(m_Driver, "Enter_Memberaddress3 " + Memberaddress3);

  		TestModellerLogger.PassStep(m_Driver, "Enter_Memberaddress3 " + Memberaddress3);
 	}

      
	/**
 	 * Enter Memberaddress4
     * @name Enter Memberaddress4
     */
 	public void Enter_Memberaddress4(String Memberaddress4)
 	{
 		try {
			m_Driver.switchTo().defaultContent();
			m_Driver.switchTo().frame(getWebElement(By.xpath("/html/body/form/main/div[11]/div[3]/div/div[6]/div/div/div/div[2]/div[3]/div/div/div[1]/div[2]/div/div/div/div[2]/iframe")));

			WebElement elem = getWebElement(Memberaddress4Elem);

			if (elem == null) {
				ExtentReportManager.failStepWithScreenshot(m_Driver, "Enter_Memberaddress4", "Enter_Memberaddress4 failed. Unable to locate object: " + Memberaddress4Elem.toString());

				TestModellerLogger.FailStepWithScreenshot(m_Driver, "Enter_Memberaddress4", "Enter_Memberaddress4 failed. Unable to locate object: " + Memberaddress4Elem.toString());

				Assert.fail("Unable to locate object: " + Memberaddress4Elem.toString());
			 }
Thread.sleep(5000);
			elem.sendKeys(Memberaddress4);
			Thread.sleep(5000);
			JavascriptExecutor je = (JavascriptExecutor)m_Driver;
			je.executeScript("arguments[0].scrollIntoView(true);",elem);
		} catch (Exception e) {
		...
		m_Driver.switchTo().defaultContent();
  		...
  		ExtentReportManager.passStep(m_Driver, "Enter_Memberaddress4 " + Memberaddress4);

  		TestModellerLogger.PassStep(m_Driver, "Enter_Memberaddress4 " + Memberaddress4);
 	}
