...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/02a4e4fc-9da5-4b08-b9fe-c4c57eae43f8
@TestModellerModule(guid = "02a4e4fc-9da5-4b08-b9fe-c4c57eae43f8")
public class Other_charges45FA775 extends BasePage
{
	public Other_charges45FA775 (WebDriver driver)
	{
		super(driver);
	}
...
//*/
	public void Click_Other_charges() {
		...
		try {
			...
			elem.click();
			Thread.sleep(5000);
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_rptrExpenseByDateRange_ctl40_lnkView\"]/span[1]")).getText();
			Assert.assertEquals(expected, "7271");
