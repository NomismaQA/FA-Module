...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/cac8b664-38f5-4cc4-91dd-932c76360ac0
@TestModellerModule(guid = "cac8b664-38f5-4cc4-91dd-932c76360ac0")
public class DetailedIncomeStatementOther_charges8 extends BasePage
{
	public DetailedIncomeStatementOther_charges8 (WebDriver driver)
	{
		super(driver);
	}
