...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/3886b4b5-49f0-49da-a0bb-f74ca5f3df39
@TestModellerModule(guid = "3886b4b5-49f0-49da-a0bb-f74ca5f3df39")
public class CostofSales9FA775 extends BasePage
{
	public CostofSales9FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(7000);
			elem.click();
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_divScroll\"]/div/table/tbody[2]/tr[8]")).getText();
			Assert.assertEquals(expected, "6060	Other direct expenses	250.00");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
