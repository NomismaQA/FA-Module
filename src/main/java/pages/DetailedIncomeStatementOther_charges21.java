...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/770c658a-f7d3-48ca-b2da-cc3b3141ea89
@TestModellerModule(guid = "770c658a-f7d3-48ca-b2da-cc3b3141ea89")
public class DetailedIncomeStatementOther_charges21 extends BasePage
{
	public DetailedIncomeStatementOther_charges21 (WebDriver driver)
	{
		super(driver);
	}
