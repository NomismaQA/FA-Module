...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/02eeb514-cdd8-436c-acd5-f9006519b587
@TestModellerModule(guid = "02eeb514-cdd8-436c-acd5-f9006519b587")
public class Verifydefaultstatusofmembersonstatementoffinancialpositionpage1 extends BasePage
{
	public Verifydefaultstatusofmembersonstatementoffinancialpositionpage1 (WebDriver driver)
	{
		super(driver);
	}
