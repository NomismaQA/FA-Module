...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/cfcdef71-4072-4b8a-b4d3-28ba9f1b96bf
@TestModellerModule(guid = "cfcdef71-4072-4b8a-b4d3-28ba9f1b96bf")
public class DetailedIncomeStatementOther_charges25 extends BasePage
{
	public DetailedIncomeStatementOther_charges25 (WebDriver driver)
	{
		super(driver);
	}
