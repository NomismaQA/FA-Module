...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/c18f2ebb-8f7b-4d42-96cf-35d7eb55bf6a
@TestModellerModule(guid = "c18f2ebb-8f7b-4d42-96cf-35d7eb55bf6a")
public class CostofSales4FA775 extends BasePage
{
	public CostofSales4FA775 (WebDriver driver)
	{
		super(driver);
	}
 ...
 */
 ...
 Thread.sleep(7000);
 			...
 			Assert.assertEquals(expected, "6085	Discount allowed	252.00");
 		} catch (Exception e) {
 			// TODO Auto-generated catch block
 			e.printStackTrace();
 		}
