...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/f12de6d2-32f6-43e6-ae41-be911d353e33
@TestModellerModule(guid = "f12de6d2-32f6-43e6-ae41-be911d353e33")
public class Depreciation_and_other_amounts_written_off_assets3FA775 extends BasePage
{
	public Depreciation_and_other_amounts_written_off_assets3FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(3000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[90]/td[2]")).getText();
						Assert.assertEquals(expected, "7625");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
