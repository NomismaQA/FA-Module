...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/f3e247d1-fc47-431b-a40f-3be256762f4b
@TestModellerModule(guid = "f3e247d1-fc47-431b-a40f-3be256762f4b")
public class Other_charges36FA775 extends BasePage
{
	public Other_charges36FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[75]/td[2]")).getText();
						Assert.assertEquals(expected, "7305");
						...
						if(data.contains("7305"))
						{
							String[] dd = data.split("0");
							System.out.println(dd[0]);
							Assert.assertEquals(dd[0], "7305");
						}
						}
		} catch (Exception e) {
			// TODO Auto-generated catch block
