...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/936dc6dc-f1b1-4e70-be36-1ca683b6e7ce
@TestModellerModule(guid = "936dc6dc-f1b1-4e70-be36-1ca683b6e7ce")
public class Other_charges9FA775 extends BasePage
{
	public Other_charges9FA775 (WebDriver driver)
	{
		super(driver);
	}
...
// 	 * Click Other_charges
 ...
 Thread.sleep(2000);
 			...
 			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
 						...
 						Assert.assertEquals(expected, "7511");
 		} catch (Exception e) {
 			// TODO Auto-generated catch block
 			e.printStackTrace();
 		}
