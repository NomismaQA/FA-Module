...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/43dc8b10-7caf-4c68-88e9-f6dd716afd04
@TestModellerModule(guid = "43dc8b10-7caf-4c68-88e9-f6dd716afd04")
public class Verify_accountants_appearing_on_partnership_information_page20 extends BasePage
{
	public Verify_accountants_appearing_on_partnership_information_page20 (WebDriver driver)
	{
		super(driver);
	}
...
elem.clear();
	...
	public void Click_Partnership_Information()
	{
		...
		elem.click();
		String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[6]/div/table[2]/tbody/tr[87]/td[1]")).getText();
		Assert.assertEquals(expected, "Accountant");  	
