...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/c5fde719-4dc7-44a9-81d3-d15b5d2d69be
@TestModellerModule(guid = "c5fde719-4dc7-44a9-81d3-d15b5d2d69be")
public class DetailedIncomeStatementOther_charges2 extends BasePage
{
	public DetailedIncomeStatementOther_charges2 (WebDriver driver)
	{
		super(driver);
	}
