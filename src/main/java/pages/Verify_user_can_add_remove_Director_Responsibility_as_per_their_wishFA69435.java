...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/2464be1c-2952-4ed6-9654-0d40bdcfa41f
@TestModellerModule(guid = "2464be1c-2952-4ed6-9654-0d40bdcfa41f")
public class Verify_user_can_add_remove_Director_Responsibility_as_per_their_wishFA69435 extends BasePage
{
	public Verify_user_can_add_remove_Director_Responsibility_as_per_their_wishFA69435 (WebDriver driver)
	{
		super(driver);
	}
