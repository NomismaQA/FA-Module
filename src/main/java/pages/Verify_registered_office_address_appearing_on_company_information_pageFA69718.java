...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/15288026-47d3-48d5-826c-886d57914ce4
@TestModellerModule(guid = "15288026-47d3-48d5-826c-886d57914ce4")
public class Verify_registered_office_address_appearing_on_company_information_pageFA69718 extends BasePage
{
	public Verify_registered_office_address_appearing_on_company_information_pageFA69718 (WebDriver driver)
	{
		super(driver);
	}
...
elem.clear();
	...
	public void Click_Filleted_Accounts()
	{
		...
		elem.click();
		String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[6]/div/table[2]/tbody/tr[49]")).getText();
