...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/a6f299e6-d4ed-48b3-9d93-94bc8388b446
@TestModellerModule(guid = "a6f299e6-d4ed-48b3-9d93-94bc8388b446")
public class CostofSales7FA775 extends BasePage
{
	public CostofSales7FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(7000);
			elem.click();
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_divScroll\"]/div/table/tbody[2]/tr[6]")).getText();
			Assert.assertEquals(expected, "6010	NIC employer	248.00");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
