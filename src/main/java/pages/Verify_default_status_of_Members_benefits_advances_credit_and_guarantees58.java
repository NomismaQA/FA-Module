...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/82d0f976-066a-474a-a4f7-b9bbae579559
@TestModellerModule(guid = "82d0f976-066a-474a-a4f7-b9bbae579559")
public class Verify_default_status_of_Members_benefits_advances_credit_and_guarantees58 extends BasePage
{
	public Verify_default_status_of_Members_benefits_advances_credit_and_guarantees58 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By Edit1Elem = By.xpath("//*[@id=\"ctl00_cPH_rptrDisplayRecords_ctl01_lnkAdd\"]");

	private By ctl00cPHddStatusElem = By.xpath("//SELECT[@name='ctl00$cPH$ddStatus']");

	private By SaveElem = By.xpath("//*[@id=\"ctl00_cPH_btnSave\"]");
...
Thread.sleep(1000);
	...
	public void Click_Full_Accounts()
	{
		...
		elem.click();
		String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[14]/div/table[2]/tbody/tr[19]/td/table/tbody/tr[1]/td")).getText();
