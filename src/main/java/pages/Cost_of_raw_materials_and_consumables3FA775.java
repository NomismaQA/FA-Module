...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/7e734fc1-7894-4789-95f0-51f8e99d95aa
@TestModellerModule(guid = "7e734fc1-7894-4789-95f0-51f8e99d95aa")
public class Cost_of_raw_materials_and_consumables3FA775 extends BasePage
{
	public Cost_of_raw_materials_and_consumables3FA775 (WebDriver driver)
	{
		super(driver);
	}
...
action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
			elem.click();
			Thread.sleep(5000);
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[26]/td[2]")).getText();
			Assert.assertEquals(expected, "6085");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} 	
