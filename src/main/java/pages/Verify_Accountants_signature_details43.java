...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/22db727e-2909-4961-85e6-2af3563ed468
@TestModellerModule(guid = "22db727e-2909-4961-85e6-2af3563ed468")
public class Verify_Accountants_signature_details43 extends BasePage
{
	public Verify_Accountants_signature_details43 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By Edit1Elem = By.xpath("//A[@id='A1']");
	...
	private By ctl00cPHtxtAddressLine1Elem = By.xpath("//INPUT[@name='ctl00$cPH$txtAddressLine1']");

	private By ctl00cPHtxtCityTownElem = By.xpath("//INPUT[@name='ctl00$cPH$txtCityTown']");
...
elem.clear();
	...
	public void Click_Full_Accounts()
	{
		...
		elem.click();
		String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[10]/div/table[2]/tbody/tr[6]/td/table/tbody/tr/td[1]/table/tbody/tr[1]/td")).getText();
