...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/2af37be0-4cf8-4f4a-8e69-626f8967ef06
@TestModellerModule(guid = "2af37be0-4cf8-4f4a-8e69-626f8967ef06")
public class Depreciation_and_other_amounts_written_off_assets5FA775 extends BasePage
{
	public Depreciation_and_other_amounts_written_off_assets5FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(3000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[91]/td[2]")).getText();
						Assert.assertEquals(expected, "7626");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
