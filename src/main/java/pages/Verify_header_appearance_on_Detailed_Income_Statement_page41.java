...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/80bdb4b1-07cc-4698-b351-196aa05c754c
@TestModellerModule(guid = "80bdb4b1-07cc-4698-b351-196aa05c754c")
public class Verify_header_appearance_on_Detailed_Income_Statement_page41 extends BasePage
{
	public Verify_header_appearance_on_Detailed_Income_Statement_page41 (WebDriver driver)
	{
		super(driver);
	}
...
elem.click();
String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[16]/div/table[1]/tbody/tr")).getText();
...
Assert.assertEquals(str[1],"Detailed Income Statement");
Assert.assertEquals(str[2],"For the year ended 31 December 2021");
System.out.println("3"+str[0]);
