...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/6223168d-c2cd-45fc-a35a-18aa440982d8
@TestModellerModule(guid = "6223168d-c2cd-45fc-a35a-18aa440982d8")
public class DetailedIncomeStatementOther_charges27 extends BasePage
{
	public DetailedIncomeStatementOther_charges27 (WebDriver driver)
	{
		super(driver);
	}
