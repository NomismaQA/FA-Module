...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/30e8d2f6-0afc-4786-8113-57029594048a
@TestModellerModule(guid = "30e8d2f6-0afc-4786-8113-57029594048a")
public class Verify_report_titlename_on_cover_page3 extends BasePage
{
	public Verify_report_titlename_on_cover_page3 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(5000);
	...
	/**
 	 * Enter ctl00$cPH$tbContainer$TbGeneral$txtCompanyName
     * @name Enter ctl00$cPH$tbContainer$TbGeneral$txtCompanyName
     */
...
//				"Unaudited Financial Statements"); 	
		...
		Assert.assertEquals(str[1],"Filleted Unaudited Financial Statements");
