...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/39901272-55e6-4457-9daf-71dae041fb15
@TestModellerModule(guid = "39901272-55e6-4457-9daf-71dae041fb15")
public class CostofSalesFA775 extends BasePage
{
	public CostofSalesFA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(5000);
			elem.click();
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[13]/div/table[2]/tbody/tr[8]")).getText();
			Assert.assertEquals(expected, "Cost of raw materials and consumables - (5,533)");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
