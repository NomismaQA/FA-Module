...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/2ca1cf4c-194d-436b-bb24-63168a795038
@TestModellerModule(guid = "2ca1cf4c-194d-436b-bb24-63168a795038")
public class Other_charges38FA775 extends BasePage
{
	public Other_charges38FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[35]/td[2]")).getText();
						Assert.assertEquals(expected, "7012");
						...
						if(data.contains("7012"))
						{
							String[] dd = data.split("0");
							System.out.println(dd[0]);
							Assert.assertEquals(dd[0], "7012");
						}
						}
		} catch (Exception e) {
			// TODO Auto-generated catch block
