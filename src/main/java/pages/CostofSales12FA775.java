...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/ca95a8f1-7458-41cf-9d0d-c4f0442bcddc
@TestModellerModule(guid = "ca95a8f1-7458-41cf-9d0d-c4f0442bcddc")
public class CostofSales12FA775 extends BasePage
{
	public CostofSales12FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(7000);
			elem.click();
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_divScroll\"]/div/table/tbody[2]/tr[11]")).getText();
			Assert.assertEquals(expected, "6080	Transportation cost	251.00");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
