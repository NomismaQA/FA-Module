...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/d8d24f53-16f6-4568-bff6-f07042678fed
@TestModellerModule(guid = "d8d24f53-16f6-4568-bff6-f07042678fed")
public class Verify_header_appearance_on_Company_Information_pageFA69712 extends BasePage
{
	public Verify_header_appearance_on_Company_Information_pageFA69712 (WebDriver driver)
	{
		super(driver);
	}
...
//		Assert.assertEquals(expected, "Registered No OC121212 (England and Wales)");  	
		...
		Assert.assertEquals(str[1],"Company Information");
		Assert.assertEquals(str[2],"For the year ended 4 April 2021");
