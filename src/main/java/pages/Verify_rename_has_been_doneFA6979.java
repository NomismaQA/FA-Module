...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/f880a8d1-9cf4-472c-9895-c3ac9f16d0be
@TestModellerModule(guid = "f880a8d1-9cf4-472c-9895-c3ac9f16d0be")
public class Verify_rename_has_been_doneFA6979 extends BasePage
{
	public Verify_rename_has_been_doneFA6979 (WebDriver driver)
	{
		super(driver);
	}
