...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/e59412cf-1ce8-465c-9008-a9b81db96932
@TestModellerModule(guid = "e59412cf-1ce8-465c-9008-a9b81db96932")
public class Staff_costs1FA775 extends BasePage
{
	public Staff_costs1FA775 (WebDriver driver)
	{
		super(driver);
	}
	...
	public void Click_Staff_Costs()
	{
		...
		try {
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[21]/td[2]")).getText();
						Assert.assertEquals(expected, "6000");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
