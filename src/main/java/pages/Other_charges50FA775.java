...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/8a35c622-8663-4feb-bac7-620e3f0eecfd
@TestModellerModule(guid = "8a35c622-8663-4feb-bac7-620e3f0eecfd")
public class Other_charges50FA775 extends BasePage
{
	public Other_charges50FA775 (WebDriver driver)
	{
		super(driver);
	}
...
//*/
	public void Click_Other_charges() {
		...
		try {
			...
			elem.click();
			Thread.sleep(5000);
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_rptrExpenseByDateRange_ctl03_lnkView\"]/span[1]")).getText();
			Assert.assertEquals(expected, "7008");
