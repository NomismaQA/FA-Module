...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/fade10b6-4db9-4263-adc9-775686c353af
@TestModellerModule(guid = "fade10b6-4db9-4263-adc9-775686c353af")
public class Verify_default_status_of_general_information_on_statement_of_financial_position_page28 extends BasePage
{
	public Verify_default_status_of_general_information_on_statement_of_financial_position_page28 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By Note_Templates_SettingsElem = By.xpath("//A[contains(text(),'Note Templates Settings')]");

	private By Edit2Elem = By.xpath("//A[@id='ctl00_cPH_rptrDisplayRecords_ctl00_lnkEdit']");

	private By ctl00cPHddStatusElem = By.xpath("//SELECT[@name='ctl00$cPH$ddStatus']");

	private By Save_ButtonElem = By.xpath("//A[@id='ctl00_cPH_btnSave']");
	...
	private By _Login_Elem = By.xpath("//BUTTON[@type='submit']");
...
Thread.sleep(5000);
     ...
     * @name Click  Login 
     */
	public void Click__Login_()
	{
        
		WebElement elem = getWebElement(_Login_Elem);

		if (elem == null) {
    		ExtentReportManager.failStepWithScreenshot(m_Driver, "Click__Login_", "Click__Login_ failed. Unable to locate object: " + _Login_Elem.toString());

    		TestModellerLogger.FailStepWithScreenshot(m_Driver, "Click__Login_", "Click__Login_ failed. Unable to locate object: " + _Login_Elem.toString());

			Assert.fail("Unable to locate object: " + _Login_Elem.toString());
        }

		elem.click();
          	

		ExtentReportManager.passStep(m_Driver, "Click__Login_");

		TestModellerLogger.PassStep(m_Driver, "Click__Login_");
	}
}