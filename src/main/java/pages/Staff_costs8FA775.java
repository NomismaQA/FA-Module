...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/3bf05bf4-49a7-49a7-8d23-dc974acaca76
@TestModellerModule(guid = "3bf05bf4-49a7-49a7-8d23-dc974acaca76")
public class Staff_costs8FA775 extends BasePage
{
	public Staff_costs8FA775 (WebDriver driver)
	{
		super(driver);
	}
	...
	public void Click_Staff_Costs()
	{
		...
		try {
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[67]/td[2]")).getText();
						Assert.assertEquals(expected, "7267");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
