...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/afd2a474-bf1f-42f7-87b4-0e3f45fa7adf
@TestModellerModule(guid = "afd2a474-bf1f-42f7-87b4-0e3f45fa7adf")
public class Staff_costs4FA775 extends BasePage
{
	public Staff_costs4FA775 (WebDriver driver)
	{
		super(driver);
	}
	...
	public void Click_Staff_Costs()
	{
		...
		try {
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[59]/td[2]")).getText();
						Assert.assertEquals(expected, "7254");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
