...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/68a91a68-e679-4ea0-8566-0db7d27b1a2a
@TestModellerModule(guid = "68a91a68-e679-4ea0-8566-0db7d27b1a2a")
public class DetailedIncomeStatementSelling_and_distribution_expenses5 extends BasePage
{
	public DetailedIncomeStatementSelling_and_distribution_expenses5 (WebDriver driver)
	{
		super(driver);
	}
