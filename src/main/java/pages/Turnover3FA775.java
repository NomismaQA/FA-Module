...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/5df4cfdb-ee70-4844-b477-a908ede3ccd1
@TestModellerModule(guid = "5df4cfdb-ee70-4844-b477-a908ede3ccd1")
public class Turnover3FA775 extends BasePage
{
	public Turnover3FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(3000);
			elem.click();
			Thread.sleep(5000);
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_divScroll\"]/div/table/tbody[2]/tr[3]")).getText();
			Assert.assertEquals(expected, "4000	Sale				(£27,276.00)");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
