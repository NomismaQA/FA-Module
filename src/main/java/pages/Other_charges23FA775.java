...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/64b42d4d-8363-4570-8fa3-13411e791d73
@TestModellerModule(guid = "64b42d4d-8363-4570-8fa3-13411e791d73")
public class Other_charges23FA775 extends BasePage
{
	public Other_charges23FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[87]/td[2]")).getText();
						Assert.assertEquals(expected, "7527");
						...
						if(data.contains("7527"))
						{
							String[] dd = data.split("0");
							System.out.println(dd[0]);
							Assert.assertEquals(dd[0], "7527");
						}
						}
		} catch (Exception e) {
			// TODO Auto-generated catch block
