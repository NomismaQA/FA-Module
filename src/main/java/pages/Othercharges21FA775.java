...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/090ba34a-188d-4bd5-9cfc-cebc7dba299a
@TestModellerModule(guid = "090ba34a-188d-4bd5-9cfc-cebc7dba299a")
public class Othercharges21FA775 extends BasePage
{
	public Othercharges21FA775 (WebDriver driver)
	{
		super(driver);
	}
