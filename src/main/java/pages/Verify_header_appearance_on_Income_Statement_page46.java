...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/069e8381-0136-4fe9-a057-33a657ea616f
@TestModellerModule(guid = "069e8381-0136-4fe9-a057-33a657ea616f")
public class Verify_header_appearance_on_Income_Statement_page46 extends BasePage
{
	public Verify_header_appearance_on_Income_Statement_page46 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By Full_AccountsElem = By.xpath("//A[@href='../AccountUI/FinalAccountPreview.aspx?FYCode=52474&CompanyCode=13266&t=Full']");
...
Thread.sleep(1000);
	...
	public void Click_Full_Accounts()
	{
		...
		String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[1]/div[3]/div[9]/table[5]/tbody/tr[1]/td")).getText();
		Assert.assertEquals(expected, "General information");
