...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/c6a0c168-50d7-431d-afbf-b74c0f8225dd
@TestModellerModule(guid = "c6a0c168-50d7-431d-afbf-b74c0f8225dd")
public class DetailedIncomeStatementSelling_and_distribution_expenses3 extends BasePage
{
	public DetailedIncomeStatementSelling_and_distribution_expenses3 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By Rental_IncomeElem = By.xpath("//TD[contains(text(),'Rental Income')]");
...
*/
	...
	/**
 	 * Click Rental Income
     * @name Click Rental Income
     */
	public void Click_Rental_Income()
	{
        
		WebElement elem = getWebElement(Rental_IncomeElem);

		if (elem == null) {
    		ExtentReportManager.failStepWithScreenshot(m_Driver, "Click_Rental_Income", "Click_Rental_Income failed. Unable to locate object: " + Rental_IncomeElem.toString());

    		TestModellerLogger.FailStepWithScreenshot(m_Driver, "Click_Rental_Income", "Click_Rental_Income failed. Unable to locate object: " + Rental_IncomeElem.toString());

			Assert.fail("Unable to locate object: " + Rental_IncomeElem.toString());
        }

		elem.click();
          	

		ExtentReportManager.passStep(m_Driver, "Click_Rental_Income");

		TestModellerLogger.PassStep(m_Driver, "Click_Rental_Income");
	}
}