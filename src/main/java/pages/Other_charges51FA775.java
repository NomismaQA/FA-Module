...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/dafedde0-8bf6-4ea0-8523-2cbee96c6e26
@TestModellerModule(guid = "dafedde0-8bf6-4ea0-8523-2cbee96c6e26")
public class Other_charges51FA775 extends BasePage
{
	public Other_charges51FA775 (WebDriver driver)
	{
		super(driver);
	}
...
//*/
	public void Click_Other_charges() {
		...
		try {
			...
			elem.click();
			Thread.sleep(5000);
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_rptrExpenseByDateRange_ctl00_lnkView\"]/span[1]")).getText();
			Assert.assertEquals(expected, "7001");
