...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/0c6b96d3-52b3-44f2-bda8-f7c4741f8fdb
@TestModellerModule(guid = "0c6b96d3-52b3-44f2-bda8-f7c4741f8fdb")
public class CostofSales6FA775 extends BasePage
{
	public CostofSales6FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(7000);
			elem.click();
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_divScroll\"]/div/table/tbody[2]/tr[5]")).getText();
			Assert.assertEquals(expected, "5101	Materials	244.00");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
