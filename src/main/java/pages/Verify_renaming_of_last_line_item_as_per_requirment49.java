...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/45c78905-7af0-47e4-8c9e-9f79a7648ea6
@TestModellerModule(guid = "45c78905-7af0-47e4-8c9e-9f79a7648ea6")
public class Verify_renaming_of_last_line_item_as_per_requirment49 extends BasePage
{
	public Verify_renaming_of_last_line_item_as_per_requirment49 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(1000);
	...
	public void Click_Income_Statement()
	{
		...
		elem.click();
		String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[12]/div/table[2]/tbody/tr[12]/td[1]")).getText();
		Assert.assertEquals(expected, "(loss)/profit for the financial year before member's remuneration and (loss)/profit shares");  	
