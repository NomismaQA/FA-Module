...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/80ddd7f7-f48c-4868-be6b-5f40993965f5
@TestModellerModule(guid = "80ddd7f7-f48c-4868-be6b-5f40993965f5")
public class Verify_dynamic_footer_pagenation54 extends BasePage
{
	public Verify_dynamic_footer_pagenation54 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By Edit1Elem = By.xpath("//*[@id=\"ctl00_cPH_rptrDisplayRecords_ctl00_lnkEdit\"]");
...
Thread.sleep(5000);
	...
	public void Click_Full_Accounts()
	{
		...
		elem.click();
		String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[16]/div/div")).getText();
