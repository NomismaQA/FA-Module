...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/a82deed0-dd28-4b86-bc1c-a8cf2ffdfebf
@TestModellerModule(guid = "a82deed0-dd28-4b86-bc1c-a8cf2ffdfebf")
public class Other_charges3FA775 extends BasePage
{
	public Other_charges3FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[31]/td[2]")).getText();
						Assert.assertEquals(expected, "7004");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
