...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/133e0fd1-762e-4461-be07-3a344a178bf6
@TestModellerModule(guid = "133e0fd1-762e-4461-be07-3a344a178bf6")
public class Turnover5FA775 extends BasePage
{
	public Turnover5FA775 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By Turnover_valueElem = By.xpath("//*[@id=\"disDiv\"]/div/div[9]/div/table[2]/tbody/tr[4]/td[5]/a");
...
Thread.sleep(3000);
			elem.click();
			List<WebElement> dd = m_Driver.findElements(By.xpath("//*[@id=\"ctl00_cPH_divScroll\"]/div/table/tbody[2]/tr/td[3]"));
			String firstvalue = dd.get(3).getText();
			String firstvalue1 = dd.get(6).getText();
			String firstvalue2 = dd.get(9).getText();
			String firstvalue3 = dd.get(12).getText();
			
			int totl = Integer.parseInt(firstvalue)+Integer.parseInt(firstvalue1)+Integer.parseInt(firstvalue2)+Integer.parseInt(firstvalue3);
			 String expectedtotal = dd.get(15).getText();
			 int extotal = Integer.parseInt(expectedtotal);
			//String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_divScroll\"]/div/table/tbody[3]/tr")).getText();
			Assert.assertEquals(totl,extotal);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
