...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/876b20dc-2b7c-43a3-99d3-e4b3f7f562fe
@TestModellerModule(guid = "876b20dc-2b7c-43a3-99d3-e4b3f7f562fe")
public class DetailedIncomeStatementOther_charges20 extends BasePage
{
	public DetailedIncomeStatementOther_charges20 (WebDriver driver)
	{
		super(driver);
	}
