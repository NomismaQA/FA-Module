...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/50873c3e-e43f-4f8c-b910-466bb0ac2620
@TestModellerModule(guid = "50873c3e-e43f-4f8c-b910-466bb0ac2620")
public class Verify_ledger_code_7958_are_included_under_loss_gain_on_revaluation_reserveFA69653 extends BasePage
{
	public Verify_ledger_code_7958_are_included_under_loss_gain_on_revaluation_reserveFA69653 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By Credit3Elem = By.xpath("//input[@name='ctl00$cPH$rptRecord$ctl01$txtCredit'][1]");
...
Thread.sleep(15000);
 	...
 	public boolean handlepopup()
	{
		...
		{
			Thread.sleep(15000);
			WebElement ele = m_Driver.findElement(By.xpath("//*[@id=\"bc0e06e8-20f8-41d7-a7af-959f82dd57cb\"]"));
...
//			m_Driver.findElement(By.xpath("//*[starts-with(text(), '4021 - Flat rate saving')]")).click();
     ...
     */
 	public void Enter_Credit3(String ctl00cPHrptRecordctl01txtCredit)
 	{
		...
		try {
			...
			if (elem == null) {
				ExtentReportManager.failStepWithScreenshot(m_Driver, "Enter_ctl00cPHrptRecordctl01txtCredit", "Enter_ctl00cPHrptRecordctl01txtCredit failed. Unable to locate object: " + Credit3Elem.toString());

				TestModellerLogger.FailStepWithScreenshot(m_Driver, "Enter_ctl00cPHrptRecordctl01txtCredit", "Enter_ctl00cPHrptRecordctl01txtCredit failed. Unable to locate object: " + Credit3Elem.toString());
