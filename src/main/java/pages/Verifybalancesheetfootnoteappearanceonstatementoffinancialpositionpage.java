...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/03daf014-6b1e-499c-a0fb-23c367e336c9
@TestModellerModule(guid = "03daf014-6b1e-499c-a0fb-23c367e336c9")
public class Verifybalancesheetfootnoteappearanceonstatementoffinancialpositionpage extends BasePage
{
	public Verifybalancesheetfootnoteappearanceonstatementoffinancialpositionpage (WebDriver driver)
	{
		super(driver);
	}
	...
	public void GoToUrl()
	{
		m_Driver.get("http://sandbox4.nomismasolution.co.uk/ssoui/Signin.aspx?token=58759b69-4890-4806-bde6-78482e0f8464");

		ExtentReportManager.passStepWithScreenshot(m_Driver, "Go to URL", "http://sandbox4.nomismasolution.co.uk/ssoui/Signin.aspx?token=58759b69-4890-4806-bde6-78482e0f8464");
		
		TestModellerLogger.PassStepWithScreenshot(m_Driver, "Go to URL", "http://sandbox4.nomismasolution.co.uk/ssoui/Signin.aspx?token=58759b69-4890-4806-bde6-78482e0f8464");
	}
   ...
   public void AssertUrl()
    {
        ...
        String expectedUrl = "http://sandbox4.nomismasolution.co.uk/ssoui/Signin.aspx?token=58759b69-4890-4806-bde6-78482e0f8464";

        if (!currentUrl.equals("http://sandbox4.nomismasolution.co.uk/ssoui/Signin.aspx?token=58759b69-4890-4806-bde6-78482e0f8464")) {
