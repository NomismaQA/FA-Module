...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/57e5472a-1762-4189-b88c-1907b15b02dd
@TestModellerModule(guid = "57e5472a-1762-4189-b88c-1907b15b02dd")
public class Other_charges2FA775 extends BasePage
{
	public Other_charges2FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						...
						Assert.assertEquals(expected, "7400");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
