...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/9c466946-c6dc-406e-9efe-e0e30f5935b8
@TestModellerModule(guid = "9c466946-c6dc-406e-9efe-e0e30f5935b8")
public class Other_charges32FA775 extends BasePage
{
	public Other_charges32FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[65]/td[2]")).getText();
						Assert.assertEquals(expected, "7264");
						...
						if(data.contains("7264"))
						{
							String[] dd = data.split("0");
							System.out.println(dd[0]);
							Assert.assertEquals(dd[0], "7264");
						}
						}
		} catch (Exception e) {
			// TODO Auto-generated catch block
