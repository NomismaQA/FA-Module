...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/1835dd51-5503-4605-9cb4-a5a725c75b35
@TestModellerModule(guid = "1835dd51-5503-4605-9cb4-a5a725c75b35")
public class Depreciation_and_other_amounts_written_off_assets7FA775 extends BasePage
{
	public Depreciation_and_other_amounts_written_off_assets7FA775 (WebDriver driver)
	{
		super(driver);
	}
  ...
  */
  ...
  Thread.sleep(3000);
  			...
  			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
  						elem.click();
  						Thread.sleep(5000);
  						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[89]/td[2]")).getText();
  						Assert.assertEquals(expected, "7624");
  		} catch (Exception e) {
  			// TODO Auto-generated catch block
  			e.printStackTrace();
  		}
