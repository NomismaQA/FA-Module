...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/42514e48-e09b-4353-9ae0-99667c464128
@TestModellerModule(guid = "42514e48-e09b-4353-9ae0-99667c464128")
public class Cost_of_raw_materials_and_consumables8FA775 extends BasePage
{
	public Cost_of_raw_materials_and_consumables8FA775 (WebDriver driver)
	{
		super(driver);
	}
...
action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
			elem.click();
			Thread.sleep(5000);
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[27]/td[2]")).getText();
			Assert.assertEquals(expected, "6090");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} 	
