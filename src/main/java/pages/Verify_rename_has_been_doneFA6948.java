...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/6ee5dbea-29ba-42b7-a94b-ed4422d03212
@TestModellerModule(guid = "6ee5dbea-29ba-42b7-a94b-ed4422d03212")
public class Verify_rename_has_been_doneFA6948 extends BasePage
{
	public Verify_rename_has_been_doneFA6948 (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _Final_Accounts_Elem = By.xpath("//A[@href='../AccountUI/FinalAccounts.aspx?FYCode=52443&CompanyCode=13249']");

	private By _Final_Accounts__1Elem = By.xpath("//LI[@id='ctl00_SideMenu1_liFinalAccounts']/A");
