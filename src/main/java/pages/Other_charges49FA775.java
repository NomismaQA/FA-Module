...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/ee994568-f074-4846-a2c9-cbe30eb5cfa1
@TestModellerModule(guid = "ee994568-f074-4846-a2c9-cbe30eb5cfa1")
public class Other_charges49FA775 extends BasePage
{
	public Other_charges49FA775 (WebDriver driver)
	{
		super(driver);
	}
...
//*/
	public void Click_Other_charges() {
		...
		try {
			...
			elem.click();
			Thread.sleep(5000);
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_rptrExpenseByDateRange_ctl20_lnkView\"]/span[1]")).getText();
			Assert.assertEquals(expected, "7204");
