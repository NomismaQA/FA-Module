...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/8fb30646-020a-42e6-b317-2ef3083539f0
@TestModellerModule(guid = "8fb30646-020a-42e6-b317-2ef3083539f0")
public class Verify_Notes_appearance_on_Statement_of_Financial_Position_page51 extends BasePage
{
	public Verify_Notes_appearance_on_Statement_of_Financial_Position_page51 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(3000);
			elem.click();
			String expected = m_Driver.findElement(By.xpath("//*[@id=\"ctl00_cPH_oldltCTPreview\"]/div/div/div[14]/div/table[2]/tbody/tr[15]/td[1]")).getText();
			Assert.assertEquals(expected, "Member's other interests");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
