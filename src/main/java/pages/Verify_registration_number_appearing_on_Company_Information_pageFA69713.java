...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/24df99e2-01fb-4c46-b2aa-5e36c58f7839
@TestModellerModule(guid = "24df99e2-01fb-4c46-b2aa-5e36c58f7839")
public class Verify_registration_number_appearing_on_Company_Information_pageFA69713 extends BasePage
{
	public Verify_registration_number_appearing_on_Company_Information_pageFA69713 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(5000);
	...
	public void Click_Filleted_Accounts()
	{
		...
		Assert.assertEquals(expected, "Company registration number OC121212 (England and Wales)");  	
