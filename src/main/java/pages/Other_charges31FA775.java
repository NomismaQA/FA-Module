...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/50c629d8-9724-4388-b5a7-d5e4db112213
@TestModellerModule(guid = "50c629d8-9724-4388-b5a7-d5e4db112213")
public class Other_charges31FA775 extends BasePage
{
	public Other_charges31FA775 (WebDriver driver)
	{
		super(driver);
	}
...
Thread.sleep(2000);
			...
			action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys(Keys.TAB).build().perform();
						elem.click();
						Thread.sleep(5000);
						String expected = m_Driver.findElement(By.xpath("//*[@id=\"table1\"]/tbody[2]/tr[69]/td[2]")).getText();
						Assert.assertEquals(expected, "7270");
						...
						if(data.contains("7270"))
						{
							String[] dd = data.split("0");
							System.out.println(dd[0]);
							Assert.assertEquals(dd[0], "7270");
						}
						}
		} catch (Exception e) {
			// TODO Auto-generated catch block
