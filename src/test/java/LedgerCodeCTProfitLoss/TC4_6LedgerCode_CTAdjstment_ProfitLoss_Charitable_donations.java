...
public class TC4_6LedgerCode_CTAdjstment_ProfitLoss_Charitable_donations extends TestBase
{
    ...
    public void LedgerCode_CTAdjstment_ProfitLoss_Charitable_donationsLedger_debit() throws Exception
    {
...
//  _JournalEntry.Enter_Enter_Debit_3(data[14]);
  ...
  _CT_Adjustment_ProfitLossTab.getCharitable_donationsBalance(data[7]);
  ...
  _CT_Adjustment_ProfitLossTab.VerifyLedgerValue();
    ...
    @TestModellerPath(guid = "90798a2f-7a6d-4763-802e-d996fa55fb26")
    public void LedgerCode_CTAdjstment_ProfitLoss_Charitable_donationsLedger_credit() throws Exception
    {
...
//  _JournalEntry.Enter_Enter_Debit_3(data[14]);
  ...
  _CT_Adjustment_ProfitLossTab.VerifyLedgerValue();
    ...
    @TestModellerPath(guid = "90798a2f-7a6d-4763-802e-d996fa55fb26")
    public void LedgerCode_CTAdjstment_ProfitLoss_Charitable_donationsLedger_Null() throws Exception
    {
