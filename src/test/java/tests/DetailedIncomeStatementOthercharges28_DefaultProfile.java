...
//https://nomisma.cloud.testinsights.io/app/#!/model-engine/guid/3a0fa027-1936-40fb-aa8e-0baf9393d00f
@Listeners(TestNGListener.class)
@TestModellerSuite(id = 1754, profileId = 102147)
public class DetailedIncomeStatementOthercharges28_DefaultProfile extends TestBase
{
	ExcelUtils ExUtils;
    ...
    @Test  (groups= {"DetailedIncomeStatementOther_charges28","DetailedIncomeStatementOther_charges28 - Default Profile"})
    @TestModellerPath(guid = "2ccf7a35-bc59-4ace-8035-e8479a56dddc")
    public void GoToUrlAssertUrl() throws InvalidFormatException
    {
    	ExUtils = new ExcelUtils();
		sTestCaseID="DetailedIncomeStatementOthercharges28_DefaultProfile";
    ...
    TestModellerLogger.SetLastNodeGuid("dbb7f2b3-be06-4028-b8f2-f33f74ce72f4");
    _DetailedIncomeStatementOther_charges28.GoToUrl();
    

    TestModellerLogger.SetLastNodeGuid("a3bb726c-adb4-4b4d-adb7-d9f8d80f37cc");
