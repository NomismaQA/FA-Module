...
//https://nomisma.cloud.testinsights.io/app/#!/model-engine/guid/b9058f93-8f7c-4bf2-8865-187ecf05c584
@Listeners(TestNGListener.class)
@TestModellerSuite(id = 1734, profileId = 102096)
public class DetailedIncomeStatementOthercharges17_DefaultProfile extends TestBase
{
	ExcelUtils ExUtils;
    ...
    @Test  (groups= {"DetailedIncomeStatementOther_charges17","DetailedIncomeStatementOther_charges17 - Default Profile"})
    @TestModellerPath(guid = "3c7137c6-b20d-49a7-87fc-2878cddb6bc0")
    public void GoToUrlAssertUrl() throws InvalidFormatException
    {
    	ExUtils = new ExcelUtils();
		sTestCaseID="DetailedIncomeStatementOthercharges17_DefaultProfile";
    ...
    TestModellerLogger.SetLastNodeGuid("53c6c34d-0536-4881-a2fb-8b87ec122278");
    _DetailedIncomeStatementOther_charges17.GoToUrl();
    

    TestModellerLogger.SetLastNodeGuid("00bb2086-fe9a-48a3-b53e-a1093876c2b1");
